...
;
if (truthy(typeof(collection) === or("string", collection instanceof Keyword))) {
;
...
;
if (truthy(collection instanceof or(Keyword, typeof(collection) === "string"))) {
;
return collection[this]
} else {
;
...
function MethodCall(method_name, ...args) {
;
this.method_name = method_name;
this.args = args
};
function method(method_name, ...args) {
;
return new MethodCall(method_name, ...args)
};
MethodCall.prototype[Call] = function (object) {
;
return object[this.method_name](...this.args)
};
function BindCall(f, ...args) {
;
this.f = f;
this.args = args
};
function bound(f, ...args) {
;
return new BindCall(f, ...args)
};
BindCall.prototype[Call] = function (object) {
;
return (this.f).bind(object)(...this.args)
};
...
;
return this[Iter].flat_map.bind(this)(compose(...fns))
};
function filter(f) {
;
...
function sort() {
;
return this[Iter].sort.bind(this)()
};
function take_last(n) {
;
return this[Iter].take_last.bind(this)(n)
};
function take(n) {
;
return this[Iter].take.bind(this)(n)
};
...
;
assert__b(typeof(other) === "number", 227, 11, `typeof(other) === "number"`,);
return js_plus(this, other)
};
Number.prototype[Minus] = function (other) {
;
assert__b(typeof(other) === "number", 232, 11, `typeof(other) === "number"`,);
return js_minus(this, other)
};
Number.prototype[Times] = function (other) {
;
assert__b(typeof(other) === "number", 237, 11, `typeof(other) === "number"`,);
return js_times(this, other)
};
Number.prototype[Divide] = function (other) {
;
assert__b(typeof(other) === "number", 242, 11, `typeof(other) === "number"`,);
return js_divide(this, other)
};
Number.prototype[Exponent] = function (other) {
;
assert__b(typeof(other) === "number", 247, 11, `typeof(other) === "number"`,);
return js_exponent(this, other)
};
Number.prototype[Mod] = function (other) {
;
assert__b(typeof(other) === "number", 252, 11, `typeof(other) === "number"`,);
...
;
assert__b(typeof(other) === "number", 266, 13, `typeof(other) === "number"`,);
return js_greater_than(this, other)
}, less_than(other) {
;
assert__b(typeof(other) === "number", 270, 13, `typeof(other) === "number"`,);
return js_less_than(this, other)
}});
String.prototype[Plus] = function (other) {
;
assert__b(typeof(other) === "string", 276, 11, `typeof(other) === "string"`,);
return js_plus(this, other)
};
String.prototype[Times] = function (amount) {
;
assert__b(typeof(amount) === "number", 281, 11, `typeof(amount) === "number"`,);
let s = "";
...
;
assert__b(typeof(other) === "string", 292, 13, `typeof(other) === "string"`,);
return js_greater_than(this, other)
}, less_than(other) {
;
assert__b(typeof(other) === "string", 296, 13, `typeof(other) === "string"`,);
return js_less_than(this, other)
}});
function plus(other) {
;
...
function float__q() {
;
return typeof(this) === and.call("number", negate(int__q(this)))
};
function even__q() {
;
...
each.bind([int__q, even__q, pos__q, float__q, as_num])(function (f) {
;
...
log.bind(reduce.bind(flat_map.bind(["123 2 20"])(method(Keyword.for("split"), " "), bound(map, as_num)))(plus, 0))()