...
Number.prototype[Equal] = new ObjectLiteral({
  eq__q(other) {
    return this === other;
  },
});
String.prototype[Equal] = new ObjectLiteral({
  eq__q(other) {
    return this === other;
  },
});
BigInt.prototype[Equal] = new ObjectLiteral({
  eq__q(other) {
    return this === other;
  },
});
Array.prototype[Equal] = new ObjectLiteral({
  eq__q(other) {
...
Map.prototype[Equal] = new ObjectLiteral({
  eq__q(other) {
...
ObjectLiteral.prototype[Equal] = new ObjectLiteral({
  eq__q(other) {
...
ObjectLiteral.prototype[Iter] = new ObjectLiteral({
  each(f) {
    return entries
      .bind(this)()
...
Array.prototype[Iter] = new ObjectLiteral({
  each(f) {
...
Set.prototype[Iter] = new ObjectLiteral({
  each(f) {
  ...
  sum() {
    return Array.from(this).reduce(plus, 0);
  },
  some__q(f) {
    for (let elem of this) {
      if (truthy(f(elem))) {
...
Function.prototype[Callable] = new ObjectLiteral({
  call(...args) {
    return this(...args);
  },
});
Set.prototype[Callable] = new ObjectLiteral({
  call(key) {
    return this.has(key);
  },
});
Map.prototype[Callable] = new ObjectLiteral({
  call(key) {
    return this.get(key);
  },
});
ObjectLiteral.prototype[Callable] = new ObjectLiteral({
  call(key) {
    return this[key];
  },
});
String.prototype[Callable] = new ObjectLiteral({
  call(collection) {
    return call.bind(collection)(this);
  },
});
Array.prototype[Callable] = new ObjectLiteral({
  call(index) {
...
String.prototype[Plus] = new ObjectLiteral({
  plus(other) {
    assert__b(typeof other === "string", 64, 13, `typeof(other) === "string"`);
    return js_plus(this, other);
  },
});
String.prototype[Times] = new ObjectLiteral({
  times(amount) {
    assert__b(
...
[
  ...
  return (op[Callable] = new ObjectLiteral({
    call(a, b) {
      return op.bind(a)(b);
    },
  }));
