...
return protocol_for.bind(this)(Callable).call(...args)
}
...
return Object.fromEntries(Object.entries(this).map(function ([k, v]) {

return f(k, v)
}))
}, filter(f) {

return Object.fromEntries(Object.entries(this).filter(function ([k, v]) {
...
return Object.entries(this).map(function ([_, v]) {
...
return Object.fromEntries(Object.entries(this).some(function ([k, v]) {

return f(k, v)
}))
}, every__q(f) {

return Object.fromEntries(Object.entries(this).every(function ([k, v]) {
...
return iter.bind(this)().insert(...args)
}
function sum() {
...
console.log(sum.bind(map.bind(map.bind([{status: "won"}, {status: "lost"}])("status"))({won: 10, lost: -10}))())
console.log(sum.bind(map.bind(map.bind(new Set([{status: "won"}, {status: "lost"}]))("status"))({won: 10, lost: -10}))())