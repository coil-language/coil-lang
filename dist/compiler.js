...
function any__q(...fns) {
return iterator_impl.bind(this)().any__q.call(this, compose(...fns));}
function all__q(...fns) {
return iterator_impl.bind(this)().all__q.call(this, compose(...fns));}
...
return str("_", into.bind(map.bind(skip.bind(this.transforms)((1)))(function ({f, args}) {
...
Keyword.for("vector_syntax")[EvalNode] = function ({entries}, constructor_expr_js) {
return str("construct_vector.call(", constructor_expr_js, ", ", "[", map_join.bind(entries)(eval_expr, ", "), "]", ")");};
Keyword.for("record_syntax")[EvalNode] = function ({entries}, constructor_expr_js) {
