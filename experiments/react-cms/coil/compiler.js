...
let iter__q = compose_decorators(
  function iter__q() {
...
let flat_map = doc(
  function flat_map(...fns) {
    return iterator_impl
      .bind(this)()
      ["flat_map"]["call"](iter.bind(this)(), compose(...fns));
  },
  `
...
let empty__q = compose_decorators(
  function empty__q() {
...
let not_empty__q = compose_decorators(
...
let update_at = doc(
  function update_at(idx, ...fns) {
    return this[OrderedSequence]["update_at"]["call"](
      this,
      idx,
      compose(...fns)
    );
...
let equals__q = compose_decorators(
...
Underscore.prototype[Keyword.for("insert")] = function (f, ...args) {
  return new Underscore(
    push.bind(this["transforms"])(new ObjectLiteral({ f: f, args: args }))
  );
};
...
Underscore.prototype[Call] = function (data, ...args) {
  if (truthy(nil__q.bind(data)())) {
    return Object["prototype"][UnderscoreInterpreter]["call"](
      data,
      this,
      ...args
    );
...
Underscore.prototype[JsLogFriendly] = function () {
  ...
  return str(
    "_",
    into.bind(
      map.bind(skip.bind(this["transforms"])(1))(function ({
        f: f,
        args: args,
      }) {
...
let lexer = construct_record.call(Lexer, [
  ...
  [/^\(/, Keyword.for("open_p")],
  [/^\)/, Keyword.for("close_p")],
  [/^[\-\+]?(\d*\.)?\d+[a-zA-Z]+/, Keyword.for("custom_number_literal")],
  [/^[\-\+]?(\d*\.)?\d+/, Keyword.for("num")],
  ...
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("double_equals"), lhs: lhs }),
      ]),
...
function parse_not_eq(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("not_equals"), lhs: lhs }),
      ]),
...
function parse_triple_eq(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("triple_equals"), lhs: lhs }),
      ]),
...
function parse_triple_not_eq(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("triple_not_equals"), lhs: lhs }),
      ]),
...
function parse_and_and(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("and_and"), lhs: lhs }),
      ]),
...
function parse_or_or(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("or_or"), lhs: lhs }),
      ]),
...
function parse_nullish(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("nullish"), lhs: lhs }),
      ]),
      construct_vector.call(Chomp, [Keyword.for("nullish")]),
      construct_vector.call(Then, [parse_expr, Keyword.for("rhs")]),
    ])
  )(tokens);
}
function parse_keyof(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("keyof"), lhs: lhs }),
      ]),
...
function parse_comparison_op(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("math_op"), lhs: lhs }),
      ]),
...
function parse_third_expr_step(tokens, lhs) {
  return call.bind(
    construct_record.call(ParseMap, [
      ...
      [Keyword.for("nullish"), parse_nullish],
...
function parse_and_dot(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("and_dot"), lhs: lhs }),
      ]),
...
function parse_dot(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("property_lookup"), lhs: lhs }),
      ]),
...
function parse_infix_bind(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("bind"), lhs: lhs }),
      ]),
...
function parse_is(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("is"), lhs: lhs }),
      ]),
...
function parse_snd_assign(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("snd_assign"), lhs: lhs }),
      ]),
...
function parse_object_dynamic_access(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(AbortIf, [not_adjacent__q]),
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("dynamic_access"), lhs: lhs }),
      ]),
      construct_vector.call(Chomp, [Keyword.for("open_sq")]),
      construct_vector.call(Then, [parse_expr, Keyword.for("expr")]),
      construct_vector.call(Chomp, [Keyword.for("close_sq")]),
...
function parse_op_eq(tokens, lhs) {
  return call.bind(
    construct_vector.call(Parser, [
      construct_vector.call(Init, [
        new ObjectLiteral({ type: Keyword.for("op_eq"), lhs: lhs }),
      ]),
...
let parse_custom_number_literal = construct_vector.call(Parser, [
  construct_vector.call(Init, [
    new ObjectLiteral({ type: Keyword.for("custom_number_literal") }),
  ]),
  construct_vector.call(One, [
    Keyword.for("custom_number_literal"),
    Keyword.for("value"),
  ]),
]);
...
let SINGLE_EXPR_PARSE_MAP = construct_record.call(ParseMap, [
  ...
  [Keyword.for("custom_number_literal"), parse_custom_number_literal],
...
function eval_default_record_syntax({
...
function eval_custom_data_literal({
  ...
  return call.bind(
    pipe.bind(at.bind(node)(Keyword.for("type")))(
      construct_record.call(Map, [
        ...
        [Keyword.for("custom_number_literal"), eval_custom_number_literal],
        ...
        [Keyword.for("nullish"), eval_nullish],
...
function eval_impl_for({
  proto_expr: proto_expr,
...
if (
  truthy(and.call(globalThis["Deno"], () => not_empty__q.bind(Deno["args"])()))
) {
