...
Object.prototype[Meta] = new ObjectLiteral({
  ["[]"]: function (...keys) {
    return reduce.bind(keys)(js_dynamic_object_lookup, this);
  },
  ["[]="]: function (keys, expr) {
...
Function.prototype[Meta] = new ObjectLiteral({
  ["[]"]: function (...args) {
...
Number.prototype[Call] = function (collection) {
  if (truthy(collection instanceof Number)) {
    raise__b(
      TypeError[Meta]["[]"].call(TypeError, "Can't call a number on a number")
    );
...
let call = compose(
  (F) => def_global(F, Keyword.for("call")),
  (F) =>
    doc(
      F,
      `
...
let pipe = compose(
  (F) => def_global(F, Keyword.for("pipe")),
  (F) =>
    doc(
      F,
      `
...
let def_call = compose(
  (F) => def_global(F, Keyword.for("def_call")),
  (F) =>
    doc(
      F,
      `
...
let iter__q = compose(def_call, (F) =>
  doc(
    F,
    `
...
let fallback_iterator_impl = new ObjectLiteral({
  *["take"](n) {
  ...
  *["zip"](...collections) {
    ...
    while (true) {
      let gen_states = into.bind(
        map.bind(generators)(function (state) {
          return state["next"]();
        })
      )([]);
...
let skip = compose(
  (F) => def_global(F, Keyword.for("skip")),
  (F) =>
    doc(
      F,
      `
...
let take = compose(
  (F) => def_global(F, Keyword.for("take")),
  (F) =>
    doc(
      F,
      `
...
let each = compose(
  (F) => def_global(F, Keyword.for("each")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["each"]["call"](iter.bind(this)(), compose(...fns));
});
let until = compose(
  (F) => def_global(F, Keyword.for("until")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["until"]["call"](iter.bind(this)(), compose(...fns));
});
let zip = compose(
  (F) => def_global(F, Keyword.for("zip")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["zip"]["call"](iter.bind(this)(), ...iterables);
});
let map = compose(
  (F) => def_global(F, Keyword.for("map")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["map"]["call"](iter.bind(this)(), compose(...fns));
});
let select = map;
globalThis["select"] = select;
let flat_map = compose(
  (F) => def_global(F, Keyword.for("flat_map")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["flat-map"]["call"](iter.bind(this)(), compose(...fns));
});
let find = compose(
  (F) => def_global(F, Keyword.for("find")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["find"]["call"](iter.bind(this)(), compose(...fns));
});
let keep = compose(
  (F) => def_global(F, Keyword.for("keep")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["keep"]["call"](iter.bind(this)(), compose(...fns));
});
let where = keep;
globalThis["where"] = where;
let reject = compose(
  (F) => def_global(F, Keyword.for("reject")),
  (F) =>
    doc(
      F,
      `
...
let any__q = compose(
  (F) => def_global(F, Keyword.for("any__q")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["any?"]["call"](iter.bind(this)(), compose(...fns));
});
let all__q = compose(
  (F) => def_global(F, Keyword.for("all__q")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["all?"]["call"](iter.bind(this)(), compose(...fns));
});
let reduce = compose(
  (F) => def_global(F, Keyword.for("reduce")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["reduce"]["call"](iter.bind(this)(), call.bind(f), start);
});
let split = compose(
  (F) => def_global(F, Keyword.for("split")),
  (F) =>
    doc(
      F,
      `
...
`
  ...
  return iterator_impl
    .bind(this)()
    ["split"]["call"](iter.bind(this)(), compose(...fns));
});
let compact = compose(
  (F) => def_global(F, Keyword.for("compact")),
  (F) =>
    doc(
      F,
      `
...
let join = compose(
  (F) => def_global(F, Keyword.for("join")),
  (F) =>
    doc(
      F,
      `
...
let into = compose(
  (F) => def_global(F, Keyword.for("into")),
  (F) =>
    doc(
      F,
      `
...
let len = compose(
  def_call,
  (F) => def_global(F, Keyword.for("len")),
  (F) =>
    doc(
      F,
      `
...
let empty__q = compose(
  def_call,
  (F) => def_global(F, Keyword.for("empty__q")),
  (F) =>
    doc(
      F,
      `
...
let not_empty__q = compose(
  def_call,
  (F) => def_global(F, Keyword.for("not_empty__q")),
  (F) =>
    doc(
      F,
      `
...
let has__q = compose(
  (F) => def_global(F, Keyword.for("has__q")),
  (F) =>
    doc(
      F,
      `
...
let in__q = compose(
  (F) => def_global(F, Keyword.for("in__q")),
  (F) => doc(F, "Inverse of ::has?")
)(function in__q(coll) {
...
let keys = compose(
  def_call,
  (F) => def_global(F, Keyword.for("keys")),
  (F) =>
    doc(
      F,
      `
...
let values = compose(
  def_call,
  (F) => def_global(F, Keyword.for("values")),
  (F) =>
    doc(
      F,
      `
...
let insert = compose(
  (F) => def_global(F, Keyword.for("insert")),
  (F) =>
    doc(
      F,
      `
...
let merge = compose(
  (F) => def_global(F, Keyword.for("merge")),
  (F) =>
    doc(
      F,
      `
...
let record__q = compose(
  (F) => def_global(F, Keyword.for("record__q")),
  (F) =>
    doc(
      F,
      `
...
globalThis["Bag"] = Bag;
let bag__q = compose(
  (F) => def_global(F, Keyword.for("bag__q")),
  (F) =>
    doc(
      F,
      `
...
Array.prototype[Bag] = new ObjectLiteral({
  ["push"](val) {
    return [...this, val];
  },
...
Set.prototype[Bag] = new ObjectLiteral({
  ["push"](value) {
...
String.prototype[Bag] = new ObjectLiteral({
  ["push"](val) {
...
let push = compose(
  (F) => def_global(F, Keyword.for("push")),
  (F) =>
    doc(
      F,
      `
...
let replace = compose(
  (F) => def_global(F, Keyword.for("replace")),
  (F) =>
    doc(
      F,
      `
...
let concat = compose(
  (F) => def_global(F, Keyword.for("concat")),
  (F) =>
    doc(
      F,
      `
...
let prepend = compose(
  (F) => def_global(F, Keyword.for("prepend")),
  (F) =>
    doc(
      F,
      `
...
let update_at = compose(
  (F) => def_global(F, Keyword.for("update_at")),
  (F) =>
    doc(
      F,
      `
...
let insert_at = compose(
  (F) => def_global(F, Keyword.for("insert_at")),
  (F) =>
    doc(
      F,
      `
...
let first = compose(
  def_call,
  (F) => def_global(F, Keyword.for("first")),
  (F) =>
    doc(
      F,
      `
...
let last = compose(
  def_call,
  (F) => def_global(F, Keyword.for("last")),
  (F) =>
    doc(
      F,
      `
...
let impl_equal = compose(
  (F) => def_global(F, Keyword.for("impl_equal")),
  (F) =>
    doc(
      F,
      `
...
let equals__q = compose(
  def_call,
  (F) => def_global(F, Keyword.for("equals__q")),
  (F) =>
    doc(
      F,
      `
...
let plus = compose(
  def_call,
  (F) => def_global(F, Keyword.for("plus")),
  (F) =>
    doc(
      F,
      `
...
let negate = compose(
  def_call,
  (F) => def_global(F, Keyword.for("negate")),
  (F) =>
    doc(
      F,
      `
...
let minus = compose(
  (F) => def_global(F, Keyword.for("minus")),
  (F) =>
    doc(
      F,
      `
...
let times = compose(
  (F) => def_global(F, Keyword.for("times")),
  (F) =>
    doc(
      F,
      `
...
let divide_by = compose(
  (F) => def_global(F, Keyword.for("divide_by")),
  (F) =>
    doc(
      F,
      `
...
let exponent = compose(
  (F) => def_global(F, Keyword.for("exponent")),
  (F) =>
    doc(
      F,
      `
...
let mod = compose(
  (F) => def_global(F, Keyword.for("mod")),
  (F) =>
    doc(
      F,
      `
...
let greater_than = compose(
  (F) => def_global(F, Keyword.for("greater_than")),
  (F) =>
    doc(
      F,
      `
...
let greater_than_eq = compose(
  (F) => def_global(F, Keyword.for("greater_than_eq")),
  (F) =>
    doc(
      F,
      `
...
let less_than = compose(
  (F) => def_global(F, Keyword.for("less_than")),
  (F) =>
    doc(
      F,
      `
...
let less_than_eq = compose(
  (F) => def_global(F, Keyword.for("less_than_eq")),
  (F) =>
    doc(
      F,
      `
...
let and = compose(
  (F) => def_global(F, Keyword.for("and")),
  (F) =>
    doc(
      F,
      `
...
let log = compose(
  (F) => def_global(F, Keyword.for("log")),
  def_call
)(function log(...args) {
...
let nan__q = compose(
  (F) => def_global(F, Keyword.for("nan__q")),
  def_call
)(function nan__q() {
  return Number["isNaN"](this);
});
let num__q = compose(
  (F) => def_global(F, Keyword.for("num__q")),
  def_call
)(function num__q() {
  return equals__q.call(typeof this, "number");
});
let bigint__q = compose(
  (F) => def_global(F, Keyword.for("bigint__q")),
  def_call
)(function bigint__q() {
  return equals__q.call(typeof this, "bigint");
});
let str__q = compose(
  (F) => def_global(F, Keyword.for("str__q")),
  def_call
)(function str__q() {
  return equals__q.call(typeof this, "string");
});
let as_keyword = compose(
  (F) => def_global(F, Keyword.for("as_keyword")),
  def_call
)(function as_keyword() {
  return Keyword["for"](this["toString"]());
});
let as_num = compose(
  (F) => def_global(F, Keyword.for("as_num")),
  def_call
)(function as_num() {
  return Number(this);
});
let as_str = compose(
  (F) => def_global(F, Keyword.for("as_str")),
  def_call
)(function as_str() {
...
let exists__q = compose(
  (F) => def_global(F, Keyword.for("exists__q")),
  def_call
)(function exists__q() {
...
}, Keyword.for("Underscore"));
Underscore.prototype[Meta] = new ObjectLiteral({
  ["[]"]: function (...keys) {
...
Underscore.prototype[Keyword.for("insert")] = function (f, ...args) {
  return Underscore[Meta]["[]"].call(
    Underscore,
    ...this["transforms"],
    new ObjectLiteral({ f: f, args: args })
  );
};
...
Underscore.prototype[Call] = function (data, ...args) {
  if (truthy(nil__q.bind(data)())) {
    return js_lookup_property_key(Object, UnderscoreInterpreter)["call"](
      data,
      this,
      ...args
    );
...
Underscore.prototype[Bag] = new ObjectLiteral({
  ["push"](value) {
...
BigInt.prototype[Inc] = function () {
  return plus.call(
    this,
    Keyword.for("custom_number_literal/n")[CustomNumberLiteral](1)
  );
};
String.prototype[Inc] = function () {
  return String["fromCharCode"](plus.call(this["charCodeAt"](0), 1));
};
let inc = compose(def_call, (F) => def_global(F, Keyword.for("int")))(
  function inc() {
    return this[Inc]();
  }
);
let IRange = compose(
  (F) => def_global(F, Keyword.for("IRange")),
  (F) => impl_equal(F, Keyword.for("start"), Keyword.for("end"))
)(function IRange(start, end) {
  this["start"] = start;
  this["end"] = end;
});
let ERange = compose(
  (F) => def_global(F, Keyword.for("ERange")),
  (F) => impl_equal(F, Keyword.for("start"), Keyword.for("end"))
)(function ERange(start, end) {
  this["start"] = start;
  this["end"] = end;
});
let IRangeNoMin = compose(
  (F) => def_global(F, Keyword.for("IRangeNoMin")),
  (F) => impl_equal(F, Keyword.for("end"))
)(function IRangeNoMin(end) {
  this["end"] = end;
});
let ERangeNoMax = compose(
  (F) => def_global(F, Keyword.for("ERangeNoMax")),
  (F) => impl_equal(F, Keyword.for("start"))
)(function ERangeNoMax(start) {
  this["start"] = start;
});
let ERangeNoMin = compose(
  (F) => def_global(F, Keyword.for("ERangeNoMin")),
  (F) => impl_equal(F, Keyword.for("end"))
)(function ERangeNoMin(end) {
  this["end"] = end;
});
IRange.prototype[Collection] = new ObjectLiteral({
  ["has?"](val) {
    return call.bind(this)(val);
  },
});
ERange.prototype[Collection] = new ObjectLiteral({
  ["has?"](val) {
    return call.bind(this)(val);
  },
});
IRangeNoMin.prototype[Collection] = new ObjectLiteral({
  ["has?"](val) {
    return call.bind(this)(val);
  },
});
ERangeNoMax.prototype[Collection] = new ObjectLiteral({
  ["has?"](val) {
    return call.bind(this)(val);
  },
});
ERangeNoMin.prototype[Collection] = new ObjectLiteral({
  ["has?"](val) {
    return call.bind(this)(val);
  },
});
...
let char_alpha__q = plus.call(
  into.bind(new IRange("a", "z"))(Set[Meta]["[]"].call(Set)),
  into.bind(new IRange("A", "Z"))(Set[Meta]["[]"].call(Set))
);
let char_numeric__q = into.bind(new IRange("0", "9"))(
  Set[Meta]["[]"].call(Set)
);
...
let alpha__q = compose(
  (F) => def_global(F, Keyword.for("alpha__q")),
  (F) => doc(F, "all characters in string are in a-z or A-Z")
)(function alpha__q() {
  return all__q.bind(this)(char_alpha__q);
});
let alpha_numeric__q = compose(
  (F) => def_global(F, Keyword.for("alpha_numeric__q")),
  (F) => doc(F, "all characters in string are in a-z or A-Z or 0-9")
...
CondMap.prototype[Call] = function (value) {
  return pipe.bind(
    find.bind(this["entries"])(function ([callable, _]) {
...
KeyedSet[Meta] = new ObjectLiteral({
  ["{}"]: function (entries) {
    let { key: key, items: items } = into.bind(entries)(new ObjectLiteral({}));
    let map = into.bind(
      select.bind(items)(function (item) {
        return [at.bind(item)(key), item];
      })
    )(Map[Meta]["{}"].call(Map, []));
...
KeyedSet.prototype[Collection] = new ObjectLiteral({
  ["at"](object) {
        ...
        if (truthy(equals__q.call(prop, Meta))) {
          return new ObjectLiteral({
            ["[]"]: function (...args) {
              return mock([
                ...chain,
                MethodCall[Meta]["[]"].call(MethodCall, args),
              ]);
            },
          });
...
CollectionView.prototype[Keyword.for("skip")] = function (n) {
  return CollectionView[Meta]["[]"].call(
    CollectionView,
    this["collection"],
    plus.call(this["idx"], n)
  );
};
CollectionView.prototype[Symbol["iterator"]] = function* () {
  for (let i of new ERange(this["idx"], len.bind(this["collection"])())) {
...
let lexer = Lexer[Meta]["{}"].call(Lexer, [
  ...
  [/^\;/, pass],
  [/^if\s/, Keyword.for("if")],
  [/^else\s/, Keyword.for("else")],
  [/^return\s/, Keyword.for("return")],
  [/^import\s/, Keyword.for("import")],
  [/^export\s/, Keyword.for("export")],
  [/^default\s/, Keyword.for("default")],
  [/^from\s/, Keyword.for("from")],
  [/^let\s/, Keyword.for("let")],
  [/^protocol\s/, Keyword.for("protocol")],
  [/^for\s/, Keyword.for("for")],
  [/^try\s/, Keyword.for("try")],
  [/^catch\s/, Keyword.for("catch")],
  [/^finally\s/, Keyword.for("finally")],
  [/^end\s/, Keyword.for("end")],
  [/^while\s/, Keyword.for("while")],
  [/^loop\s/, Keyword.for("loop")],
  [/^and\s/, Keyword.for("and")],
  [/^or\s/, Keyword.for("or")],
  [/^continue\s/, Keyword.for("continue")],
  [/^break\s/, Keyword.for("break")],
  [/^of\s/, Keyword.for("of")],
  [/^yield\s/, Keyword.for("yield")],
  [/^async\s/, Keyword.for("async")],
  [/^await\s/, Keyword.for("await")],
  [/^\=\>/, Keyword.for("arrow")],
  [/^\@/, Keyword.for("at")],
  ...
  [/^\(/, Keyword.for("open_p")],
  [/^\)/, Keyword.for("close_p")],
  [/^\|/, Keyword.for("pipe_bar")],
  [/^[\-\+]?(\d+\.)?\d+n/, Keyword.for("bigint")],
  [/^[\-\+]?(\d+\.)?\d+/, Keyword.for("num")],
...
function ParseError(expected_token_type, actual_token) {
  ...
  this["message"] = str(
    ...
    expected_token_type,
    " got ",
    at.bind(actual_token)(Keyword.for("type")),
    " @ ",
...
function verify_exists__b(parser) {
  if (truthy(nil__q.bind(this)())) {
    raise__b(
      Error[Meta]["[]"].call(
        Error,
        plus.call("Parser Failed - Expected ", parser)
      )
    );
  } else {
    return this;
...
One.prototype[ParseInstruction] = function ([expr, tokens]) {
  let { value: value, type: type } = first.bind(
    expect_token__b.bind(tokens)(this["kw"])
  )();
  return [
...
Optional.prototype[ParseInstruction] = function ([expr, tokens]) {
  ...
  if (
    ...
    return parse_step.bind(
      Then[Meta]["[]"].call(Then, this["parse_fn"], this["as"])
    )([expr, tokens]);
  } else if (
...
Until.prototype[ParseInstruction] = function ([expr, tokens]) {
  ...
  if (truthy(this["kw"])) {
    return [
      merge.bind(expr)(new ObjectLiteral({ [this["kw"]]: exprs })),
      tokens,
    ];
  } else {
    return [exprs, tokens];
...
UntilEither.prototype[ParseInstruction] = function ([expr, tokens]) {
  ...
  while (
    negate.call(
      pipe.bind(at.bind(first.bind(tokens)())(Keyword.for("type")))(this["set"])
    )
  ) {
    let [expr, new_tokens] = verify_exists__b.bind(
      call.bind(this["parser"])(tokens)
...
Either.prototype[ParseInstruction] = function ([expr, tokens]) {
  ...
  return [
    merge.bind(expr)(
      new ObjectLiteral({
        [this["kw"]]: at.bind(new_expr)(Keyword.for("value")),
      })
    ),
    rest,
  ];
...
ParseMap.prototype[Record] = new ObjectLiteral({
  ["keys"]() {
    return into.bind(map.bind(this["entries"])(first))(
      Set[Meta]["[]"].call(Set)
    );
  },
});
  ...
  for (let [pattern, parser] of this["entries"]) {
    if (truthy(equals__q.call(pattern, _))) {
      ...
      and.call(pattern instanceof Array, () =>
        all__q.bind(zip.bind(pattern)(tokens))(function ([p, token]) {
...
function parse_dot(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("dot"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("dot")),
      Then[Meta]["[]"].call(Then, parse_single_expr, Keyword.for("rhs"))
    )
  )(tokens);
}
function parse_keyword_lookup(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      Parser,
      AbortIf[Meta]["[]"].call(AbortIf, not_adjacent__q),
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("keyword_lookup"), lhs: lhs })
      ),
      One[Meta]["[]"].call(
        One,
        Keyword.for("keyword"),
      ...
      FMap[Meta]["[]"].call(
        FMap,
        function ({ lhs: lhs, type: type, property: property }) {
          return new ObjectLiteral({
            lhs: lhs,
            type: type,
...
function not_adjacent__q([_expr, tokens]) {
  ...
  let end_of_prev_token = plus.call(
    previous["col"],
...
function parse_adjacent_expr(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      Parser,
      AbortIf[Meta]["[]"].call(AbortIf, not_adjacent__q),
      Then[Meta]["[]"].call(Then, parse_expr)
    )
  )(tokens);
}
function parse_inclusive_range(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("inclusive_range"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("dot_dot"), Keyword.for("eq")),
      Optional[Meta]["[]"].call(
        Optional,
...
function parse_exclusive_range(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("exclusive_range"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("dot_dot")),
      Optional[Meta]["[]"].call(
        Optional,
        keys.bind(SINGLE_EXPR_PARSE_MAP)(),
        parse_adjacent_expr,
...
function parse_fn_call(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("fn_call"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("open_p")),
      Until[Meta]["[]"].call(
        Until,
        Keyword.for("close_p"),
        parse_expr,
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("close_p"))
    )
  )(tokens);
}
function parse_meta_from_entries(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("meta_from_entries"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("open_b")),
      Until[Meta]["[]"].call(
        Until,
        Keyword.for("close_b"),
        parse_record_entry,
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("close_b"))
    )
  )(tokens, lhs);
}
function parse_meta_create(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("meta_create"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("open_sq")),
      Until[Meta]["[]"].call(
        Until,
        Keyword.for("close_sq"),
        parse_expr,
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("close_sq"))
    )
  )(tokens, lhs);
}
function parse_snd_expr_step(tokens, lhs) {
  return call.bind(
    ParseMap[Meta]["{}"].call(ParseMap, [
      [Keyword.for("open_p"), parse_fn_call],
      [Keyword.for("open_b"), parse_meta_from_entries],
      [Keyword.for("open_sq"), parse_meta_create],
      [Keyword.for("dot"), parse_dot],
      [Keyword.for("keyword"), parse_keyword_lookup],
...
function parse_algebra_op(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("algebra_op"), lhs: lhs })
      ),
      Either[Meta]["[]"].call(Either, algebra_ops, Keyword.for("op")),
      Then[Meta]["[]"].call(Then, parse_1_2_expr, Keyword.for("rhs"))
    )
  )(tokens);
}
function parse_third_expr_step(tokens, lhs) {
  return call.bind(
    ParseMap[Meta]["{}"].call(ParseMap, [[algebra_ops, parse_algebra_op]])
  )(tokens, lhs);
}
...
function parse_eq_op(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("equality_op"), lhs: lhs })
      ),
      Either[Meta]["[]"].call(
        Either,
        Set[Meta]["[]"].call(
      ...
      Then[Meta]["[]"].call(Then, parse_1_2_3_expr, Keyword.for("rhs"))
    )
  )(tokens);
}
...
function parse_and(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("and"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("and")),
      Then[Meta]["[]"].call(Then, parse_1_2_3_4_expr, Keyword.for("rhs"))
    )
  )(tokens);
}
function parse_or(tokens, lhs) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("or"), lhs: lhs })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("or")),
      Then[Meta]["[]"].call(Then, parse_1_2_3_4_expr, Keyword.for("rhs"))
    )
  )(tokens);
}
...
let parse_regex = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("regex_lit") })
  ),
  One[Meta]["[]"].call(One, Keyword.for("regex_lit"), Keyword.for("value"))
);
let parse_str = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(Init, new ObjectLiteral({ type: Keyword.for("str") })),
  One[Meta]["[]"].call(One, Keyword.for("string_lit"), Keyword.for("value"))
);
let valid_ids_in_all_contexts = Set[Meta]["[]"].call(
  Set,
  Keyword.for("id"),
  Keyword.for("from")
);
let parse_id = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
...
function parse_obj(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("object_literal") })
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("open_b")),
      Until[Meta]["[]"].call(
        Until,
...
let parse_spread_assign = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("spread_assign") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("dot_dot_dot")),
  Either[Meta]["[]"].call(
    Either,
...
let parse_assign_id = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
...
let parse_obj_entry_rename = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
  ...
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("colon")),
  Either[Meta]["[]"].call(
    Either,
    valid_ids_in_all_contexts,
...
let parse_regular_obj_assign_entry = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
...
function parse_obj_entry_destructure(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("obj_assign_expr") })
      ),
      One[Meta]["[]"].call(
        One,
        valid_ids_in_all_contexts,
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("colon")),
      Then[Meta]["[]"].call(Then, parse_assign_expr, Keyword.for("assign_expr"))
    )
  )(tokens);
}
let parse_obj_assign_entry = ParseMap[Meta]["{}"].call(ParseMap, [
  [
    [Keyword.for("id"), Keyword.for("colon"), Keyword.for("id")],
    parse_obj_entry_rename,
  ],
  [[Keyword.for("id"), Keyword.for("colon")], parse_obj_entry_destructure],
  [Keyword.for("id"), parse_regular_obj_assign_entry],
  [Keyword.for("dot_dot_dot"), parse_spread_assign],
]);
let parse_assign_obj = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
...
let parse_this_assign = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("this_assign") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("at")),
  Either[Meta]["[]"].call(
    Either,
    valid_ids_in_all_contexts,
    Keyword.for("name")
...
let parse_this_spread_assign = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("this_spread_assign") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("dot_dot_dot"), Keyword.for("at")),
  One[Meta]["[]"].call(One, Keyword.for("id"), Keyword.for("name"))
);
let parse_assign_expr = ParseMap[Meta]["{}"].call(ParseMap, [
  ...
  [[Keyword.for("dot_dot_dot"), Keyword.for("at")], parse_this_spread_assign],
  [Keyword.for("dot_dot_dot"), parse_spread_assign],
]);
function parse_paren_expr(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("open_p")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("expr")),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("close_p"))
    )
  )(tokens);
}
function parse_yield(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("yield")),
      Optional[Meta]["[]"].call(
        Optional,
        Keyword.for("times"),
        parse_gen_modifier,
...
function parse_await(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("await")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("expr"))
    )
  )(tokens);
}
let parse_num = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(Init, new ObjectLiteral({ type: Keyword.for("num") })),
  One[Meta]["[]"].call(One, Keyword.for("num"), Keyword.for("value"))
);
...
function parse_not(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("bang")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("expr"))
    )
  )(tokens);
}
...
let parse_adjacent_num_raw = Parser[Meta]["[]"].call(
  Parser,
  AbortIf[Meta]["[]"].call(AbortIf, not_adjacent__q),
  Then[Meta]["[]"].call(Then, parse_num_raw)
);
let parse_async_modifier = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(Init, true),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("async"))
);
let parse_gen_modifier = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(Init, true),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("times"))
);
function parse_fn_expr_body(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("eq")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("expr")),
      FMap[Meta]["[]"].call(FMap, function (node) {
        return [node];
      })
    )
  )(tokens);
...
function parse_args_def(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      Parser,
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("open_p")),
      Until[Meta]["[]"].call(Until, Keyword.for("close_p"), parse_assign_expr),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("close_p"))
    )
  )(tokens);
}
function parse_name_expr(tokens) {
  ...
  if (truthy(__coil_if_let_temp)) {
    ...
    let parse_map = ParseMap[Meta]["{}"].call(ParseMap, [
      [Keyword.for("dot"), parse_dot],
      [Keyword.for("keyword"), parse_keyword_lookup],
    ]);
  ...
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Optional[Meta]["[]"].call(
        ...
        Keyword.for("is_async?")
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("fn")),
      Optional[Meta]["[]"].call(
        Optional,
        Keyword.for("times"),
        parse_gen_modifier,
        Keyword.for("generator?")
      ),
      Then[Meta]["[]"].call(Then, parse_name_expr, Keyword.for("name_expr")),
      Optional[Meta]["[]"].call(
        Optional,
        Keyword.for("open_p"),
        parse_args_def,
...
function parse_regular_record_entry(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("key_expr")),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("arrow")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("value_expr"))
    )
  )(tokens);
}
function parse_record_entry(tokens) {
  return call.bind(
    ParseMap[Meta]["{}"].call(ParseMap, [
      ...
      [[Keyword.for("id"), Keyword.for("arrow")], parse_regular_record_entry],
...
function parse_keyword(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      One[Meta]["[]"].call(One, Keyword.for("keyword"), Keyword.for("value")),
      FMap[Meta]["[]"].call(FMap, function ({ type: type, value: value }) {
        return new ObjectLiteral({ type: type, value: value["slice"](1) });
      })
    )
  )(tokens);
}
let parse_anon_fn = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("anon_fn") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("pipe_bar")),
  Until[Meta]["[]"].call(
    Until,
    Keyword.for("pipe_bar"),
    parse_assign_expr,
  ...
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("pipe_bar")),
  Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("return_expr"))
);
function parse_reassign(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      Parser,
      Init[Meta]["[]"].call(
        Init,
        new ObjectLiteral({ type: Keyword.for("reassign") })
      ),
      One[Meta]["[]"].call(One, Keyword.for("id"), Keyword.for("name")),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("eq")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("expr"))
...
let SINGLE_EXPR_PARSE_MAP = ParseMap[Meta]["{}"].call(ParseMap, [
  ...
  [Keyword.for("pipe_bar"), parse_anon_fn],
  [[Keyword.for("id"), Keyword.for("eq")], parse_reassign],
  [[Keyword.for("dot_dot"), Keyword.for("eq")], parse_prefix_inclusive_range],
  [Keyword.for("dot_dot"), parse_prefix_exclusive_range],
  [push.bind(valid_ids_in_all_contexts)(Keyword.for("import")), parse_id],
  [[Keyword.for("async"), Keyword.for("fn")], parse_fn],
  [Keyword.for("fn"), parse_fn],
]);
...
function parse_expr(tokens) {
  return parse_fifth_expr(
    parse_fourth_expr(
      parse_third_expr(parse_snd_expr(parse_single_expr(tokens)))
    )
  );
}
...
function parse_else_branch(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("else")),
      UntilEither[Meta]["[]"].call(
        UntilEither,
        Set[Meta]["[]"].call(Set, Keyword.for("else"), Keyword.for("end")),
        parse_statement,
        Keyword.for("body")
      )
    )
...
function parse_else_if_branch(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("else"), Keyword.for("if")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("expr")),
      UntilEither[Meta]["[]"].call(
        UntilEither,
        Set[Meta]["[]"].call(Set, Keyword.for("else"), Keyword.for("end")),
...
let parse_if_branch = ParseMap[Meta]["{}"].call(ParseMap, [
...
function parse_if(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("if")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("expr")),
      UntilEither[Meta]["[]"].call(
        UntilEither,
        Set[Meta]["[]"].call(Set, Keyword.for("else"), Keyword.for("end")),
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("end"))
    )
  )(tokens);
}
let parse_let = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(Init, new ObjectLiteral({ type: Keyword.for("let") })),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("let")),
  Then[Meta]["[]"].call(Then, parse_assign_expr, Keyword.for("assign_expr")),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("eq")),
  Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("rhs"))
);
function parse_if_let(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("if"), Keyword.for("let")),
      Then[Meta]["[]"].call(
        Then,
        parse_assign_expr,
...
let parse_protocol_methods = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("protocol_method") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("open_b")),
  Until[Meta]["[]"].call(
    Until,
...
let parse_protocol = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("protocol_def") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("protocol")),
  One[Meta]["[]"].call(One, Keyword.for("id"), Keyword.for("name")),
  Optional[Meta]["[]"].call(
    Optional,
    Keyword.for("open_b"),
    parse_protocol_methods,
    Keyword.for("methods")
  )
);
let parse_return = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("return") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("return")),
  Optional[Meta]["[]"].call(
    Optional,
    keys.bind(SINGLE_EXPR_PARSE_MAP)(),
    parse_expr,
...
let parse_await_modifier = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(Init, true),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("await"))
);
function parse_for_loop(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("for")),
      Optional[Meta]["[]"].call(
        Optional,
        Keyword.for("await"),
        parse_await_modifier,
        Keyword.for("is_await?")
      ),
      Then[Meta]["[]"].call(
        Then,
        parse_assign_expr,
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("of")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("iterable_expr")),
...
function parse_loop(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("loop")),
      block(Keyword.for("body"))
    )
  )(tokens);
}
function parse_while_loop(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("while")),
      Then[Meta]["[]"].call(Then, parse_expr, Keyword.for("test_expr")),
      block(Keyword.for("body"))
    )
  )(tokens);
}
function parse_while_let_loop(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("while"), Keyword.for("let")),
      Then[Meta]["[]"].call(
        Then,
        parse_assign_expr,
        Keyword.for("assign_expr")
...
function parse_continue(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("continue"))
    )
  )(tokens);
}
function parse_break(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("break"))
    )
  )(tokens);
}
function parse_catch(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("catch")),
      One[Meta]["[]"].call(One, Keyword.for("id"), Keyword.for("name")),
      block(Keyword.for("body"))
    )
  )(tokens);
...
function parse_finally(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("finally")),
      block(Keyword.for("body"))
    )
  )(tokens);
}
function parse_try(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("try")),
      block(Keyword.for("body")),
      Optional[Meta]["[]"].call(
        Optional,
        Keyword.for("catch"),
...
function parse_import(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("import")),
      Then[Meta]["[]"].call(
        Then,
        parse_assign_expr,
        Keyword.for("assign_exprs")
      ),
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("from")),
      Then[Meta]["[]"].call(Then, parse_str, Keyword.for("path"))
    )
  )(tokens);
}
function parse_export(tokens) {
  return call.bind(
    Parser[Meta]["[]"].call(
      ...
      Chomp[Meta]["[]"].call(Chomp, Keyword.for("export")),
      Then[Meta]["[]"].call(Then, parse_statement, Keyword.for("statement"))
    )
  )(tokens);
}
...
let parse_direct_import = Parser[Meta]["[]"].call(
  Parser,
  Init[Meta]["[]"].call(
    Init,
    new ObjectLiteral({ type: Keyword.for("direct_import") })
  ),
  Chomp[Meta]["[]"].call(Chomp, Keyword.for("import")),
  One[Meta]["[]"].call(One, Keyword.for("string_lit"), Keyword.for("path"))
);
function parse_statement(tokens) {
  return call.bind(
    ParseMap[Meta]["{}"].call(ParseMap, [
      ...
      [[Keyword.for("import"), Keyword.for("string_lit")], parse_direct_import],
...
function block(name) {
  return Parser[Meta]["[]"].call(
    Parser,
    Until[Meta]["[]"].call(Until, Keyword.for("end"), parse_statement, name),
    Chomp[Meta]["[]"].call(Chomp, Keyword.for("end"))
  );
}
...
function eval_if_branch(branch) {
  if (truthy(nil__q.bind(branch)())) {
    ...
    if (
      truthy(
        equals__q.call(
          call.call(Keyword.for("type"), branch),
          Keyword.for("else_if")
        )
      )
    ) {
...
function eval_obj_deconstruction_entry(node) {
  return call.bind(
    pipe.bind(at.bind(node)(Keyword.for("type")))(
      Map[Meta]["{}"].call(Map, [
        [Keyword.for("obj_reg_entry"), eval_obj_reg_entry],
        [Keyword.for("obj_entry_rename"), eval_obj_entry_rename],
        [Keyword.for("spread_assign"), eval_spread_assign],
        [
          Keyword.for("obj_str_rename_entry"),
          function ({ old_name: old_name, new_name: new_name }) {
            return str(old_name, ": ", resolve_name(new_name));
          },
        ],
      ])
  ...
  return call.bind(
    pipe.bind(at.bind(node)(Keyword.for("type")))(
      Map[Meta]["{}"].call(Map, [
        ...
        [Keyword.for("this_spread_assign"), eval_spread_assign],
      ])
    )
  )(node);
}
function eval_while_let_loop({
  test_expr: test_expr,
    ...
    map.bind(
      keep.bind(args)(
        ...
        Set[Meta]["[]"].call(
          ...
          Keyword.for("this_spread_assign")
        )
      )
    )(function ({ name: name }) {
...
function eval_name_expr(node) {
  return pipe.bind(at.bind(node)(Keyword.for("type")))(
    Map[Meta]["{}"].call(Map, [
      [
        Keyword.for("dot"),
        function ({ lhs: lhs, rhs: rhs }) {
          return str(eval_name_expr(lhs), "[", eval_name_expr(rhs), "]");
        },
      ],
      [
        Keyword.for("keyword_lookup"),
        function ({ lhs: lhs, property: property }) {
          return str(eval_name_expr(lhs), "['", property, "']");
        },
      ],
    ]),
    or.call(_, () => eval_expr)
...
function eval_fn({
  "is_async?": is_async__q,
  "generator?": generator__q,
  name_expr: name_expr,
  args: args,
  body: body,
}) {
  return str(
    or.call(
      and.call(
        equals__q.call(name_expr["type"], Keyword.for("id_lookup")),
        () => "let "
      ),
      () => ""
    ),
...
function eval_regular_record_entry({
  key_expr: key_expr,
...
function eval_keyword_record_entry({ name: name, expr: expr }) {
  return str(
    "[",
    eval_keyword(new ObjectLiteral({ value: name })),
    ", ",
    eval_expr(expr),
    "]"
  );
  ...
  return call.bind(
    pipe.bind(at.bind(node)(Keyword.for("type")))(
      Map[Meta]["{}"].call(Map, [
        ...
        [
          Keyword.for("id_shorthand_record_entry"),
...
function eval_reassign({ name: name, expr: expr }) {
...
function eval_expr(node) {
  return call.bind(
    pipe.bind(at.bind(node)(Keyword.for("type")))(
      Map[Meta]["{}"].call(Map, [
        [Keyword.for("algebra_op"), eval_algebra_op],
        [Keyword.for("equality_op"), eval_equality_op],
        [Keyword.for("and"), eval_and],
        [Keyword.for("or"), eval_or],
        [Keyword.for("str"), eval_str],
        [Keyword.for("dot"), eval_dot],
        [Keyword.for("reassign"), eval_reassign],
        [Keyword.for("keyword_lookup"), eval_keyword_lookup],
        [Keyword.for("object_literal"), eval_object_literal],
        ...
        [Keyword.for("meta_from_entries"), eval_meta_from_entries],
        [Keyword.for("meta_create"), eval_meta_create],
        [Keyword.for("spread"), eval_spread],
        ...
        [Keyword.for("anon_fn"), eval_anon_fn],
      ])
    )
  )(node);
}
...
function eval_protocol({ name: name, methods: methods }) {
  if (truthy(methods)) {
    return str(
      ...
      name,
      " = Object.freeze({",
      map_join.bind(methods["names"])(function (entry) {
        return str(
          '"',
          entry["name"],
          '": Symbol("',
...
function eval_for_loop({
  "is_await?": is_await__q,
  assign_expr: assign_expr,
...
Deno["writeTextFile"](
  out_name,
  plus.call(imports, plus.call(compile(src), "\n"))
);
