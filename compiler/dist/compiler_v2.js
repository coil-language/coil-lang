...
return call.bind(Parser[Meta]['[]'].call(Parser, AbortIf[Meta]['[]'].call(AbortIf, not_adjacent__q), Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("keyword_lookup"), 'lhs':lhs})), One[Meta]['[]'].call(One, Keyword.for("keyword"), Keyword.for("property")), FMap[Meta]['[]'].call(FMap, function ({'lhs': lhs, 'type': type, 'property': property}) {
return new ObjectLiteral({'lhs':lhs, 'type':type, 'property': property['slice']((1))});})))(tokens);}
...
return call.bind(ParseMap[Meta]['{}'].call(ParseMap, [[Keyword.for("open_p"), parse_fn_call], [Keyword.for("open_b"), parse_meta_from_entries], [Keyword.for("open_sq"), parse_meta_create], [Keyword.for("dot"), parse_dot], [Keyword.for("keyword"), parse_keyword_lookup], [[Keyword.for("dot_dot"), Keyword.for("eq")], parse_inclusive_range], [Keyword.for("dot_dot"), parse_exclusive_range]]))(tokens, lhs);}
...
let parse_map = ParseMap[Meta]['{}'].call(ParseMap, [[Keyword.for("dot"), parse_dot], [Keyword.for("keyword"), parse_keyword_lookup]]);
...
return call.bind(ParseMap[Meta]['{}'].call(ParseMap, [[Keyword.for("dot_dot_dot"), parse_spread], [[Keyword.for("id"), Keyword.for("colon")], parse_keyword_record_entry], [[Keyword.for("id"), Keyword.for("arrow")], parse_regular_record_entry], [Keyword.for("fn"), parse_fn], [[Keyword.for("async"), Keyword.for("fn")], parse_fn], [_, parse_regular_record_entry]]))(tokens);}
...
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("keyword")})), One[Meta]['[]'].call(One, Keyword.for("keyword"), Keyword.for("value")), FMap[Meta]['[]'].call(FMap, function ({'type': type, 'value': value}) {
return new ObjectLiteral({'type':type, 'value': value['slice']((1))});})))(tokens);}
...
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("reassign")})), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("name")), Chomp[Meta]['[]'].call(Chomp, Keyword.for("eq")), Then[Meta]['[]'].call(Then, parse_expr, Keyword.for("expr"))))(tokens);}
...
return call.bind(pipe.bind(at.bind(node)(Keyword.for("type")))(Map[Meta]['{}'].call(Map, [[Keyword.for("id_assign"), eval_id_assign_name], [Keyword.for("spread_assign"), eval_spread_assign], [Keyword.for("array_deconstruction"), eval_array_deconstruction_names], [Keyword.for("object_deconstruction"), eval_object_deconstruction_names]])))(node);}
...
function entries_arg_names({'entries': entries}) {
return entries['flatMap'](arg_names);}
function arg_names(node) {
return call.bind(pipe.bind(at.bind(node)(Keyword.for("type")))(Map[Meta]['{}'].call(Map, [[Keyword.for("array_deconstruction"), entries_arg_names], [Keyword.for("id_assign"), function ({'name': name}) {
return [name];}], [Keyword.for("object_deconstruction"), entries_arg_names], [Keyword.for("obj_reg_entry"), function ({'name': name}) {
...
return str("(__coil_temp = {left: ", eval_expr(lhs), "}", ", __coil_temp.left[Meta.as_bool]() === false ? __coil_temp.left : (__coil_temp.right = ", eval_expr(rhs), ", __coil_temp.right[Meta.as_bool]() === true) ? __coil_temp.right : __coil_temp.left)");}
function eval_or({'lhs': lhs, 'rhs': rhs}) {
return str("(__coil_temp = {left: ", eval_expr(lhs), "}", ", __coil_temp.left[Meta.as_bool]() ? __coil_temp.left : ", eval_expr(rhs), ")");}
