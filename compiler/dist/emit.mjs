...
if ((name[Meta["=="]]("new"))[Meta.as_bool]()) {
let __coil_temp;
return "__new__";
} else if ((name[Meta["=="]]("delete"))[Meta.as_bool]()) {
let __coil_temp;
return "__delete__";
} else if ((name)[Meta.as_bool]()) {
let __coil_temp;
return dot(dot(dot(name, Keyword.for("replaceAll"))[invoke]("?", "__q"), Keyword.for("replaceAll"))[invoke]("!", "__b"), Keyword.for("replaceAll"))[invoke](">", "_lt_");
} else {
let __coil_temp;
return name;
};};
...
let eval_dot_yield = function ({'lhs': lhs}) {
lhs ??= nil;let __coil_temp;
return str[invoke]("(yield ", eval_expr[invoke](lhs), ")");};
