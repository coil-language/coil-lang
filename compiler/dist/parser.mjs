...
tokens ??= nil;let __coil_temp;
return ParseMap[Meta.from_entries]([[Keyword.for("dot_dot_dot"), parse_spread], [[Keyword.for("id"), Keyword.for("colon")], parse_keyword_record_entry], [[Keyword.for("id"), Keyword.for("arrow")], parse_regular_record_entry], [Keyword.for("fn"), parse_fn], [Keyword.for("def"), parse_def], [[Keyword.for("async"), Keyword.for("fn")], parse_fn], [[Keyword.for("async"), Keyword.for("def")], parse_def], [_, parse_regular_record_entry]])[invoke](tokens);};
