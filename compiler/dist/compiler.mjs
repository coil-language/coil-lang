...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("double_equals"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("double_eq")]), construct_vector.call(Then, [parse_1_2_expr, Keyword.for("rhs")])]))(tokens);}
function parse_not_eq(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("not_equals"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("not_eq")]), construct_vector.call(Then, [parse_1_2_expr, Keyword.for("rhs")])]))(tokens);}
function parse_triple_eq(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("triple_equals"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("triple_eq")]), construct_vector.call(Then, [parse_1_2_expr, Keyword.for("rhs")])]))(tokens);}
function parse_triple_not_eq(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("triple_not_equals"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("triple_not_eq")]), construct_vector.call(Then, [parse_1_2_expr, Keyword.for("rhs")])]))(tokens);}
function parse_and_and(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("and_and"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("and_and")]), construct_vector.call(Then, [parse_expr, Keyword.for("rhs")])]))(tokens);}
function parse_or_or(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("or_or"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("or_or")]), construct_vector.call(Then, [parse_expr, Keyword.for("rhs")])]))(tokens);}
function parse_nullish(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("nullish"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("nullish")]), construct_vector.call(Then, [parse_expr, Keyword.for("rhs")])]))(tokens);}
function parse_keyof(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("keyof"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("keyof")]), construct_vector.call(Then, [parse_expr, Keyword.for("rhs")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("partial_obj_dyn_access")})), construct_vector.call(Chomp, [Keyword.for("open_sq")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), construct_vector.call(Chomp, [Keyword.for("close_sq")])]))(tokens);}
function parse_partial_fn_call(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("partial_fn_call")})), construct_vector.call(Chomp, [Keyword.for("open_p")]), construct_vector.call(Until, [Keyword.for("close_p"), parse_expr, Keyword.for("args")]), construct_vector.call(Chomp, [Keyword.for("close_p")])]))(tokens);}
function parse_and_dot(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("and_dot"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("single_and"), Keyword.for("dot")]), construct_vector.call(Case, [construct_record.call(ParseMap, [[Keyword.for("id"), parse_id], [Keyword.for("open_sq"), parse_partial_obj_dyn_access], [Keyword.for("open_p"), parse_partial_fn_call]]), Keyword.for("rhs")])]))(tokens);}
function parse_dot(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("property_lookup"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("dot")]), construct_vector.call(Either, [Set[Meta]['[]'].call(Set, Keyword.for("id"), Keyword.for("from")), Keyword.for("property")])]))(tokens);}
function parse_infix_bind(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("bind"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("double_colon")]), construct_vector.call(Case, [construct_record.call(ParseMap, [[Keyword.for("id"), parse_id], [Keyword.for("fn"), parse_fn], [[Keyword.for("tilde"), Keyword.for("id"), Keyword.for("open_b")], parse_record_syntax], [all_math_ops, parse_unapplied_math_op], [Keyword.for("open_p"), parse_paren_expr]]), Keyword.for("expr")])]))(tokens);}
function parse_is(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("is"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("is")]), construct_vector.call(Then, [parse_1_2_expr, Keyword.for("rhs")])]))(tokens);}
function parse_snd_assign(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("snd_assign"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("rhs")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [construct_vector.call(AbortIf, [not_adjacent__q]), Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("fn_call"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("open_p")]), construct_vector.call(Until, [Keyword.for("close_p"), parse_expr, Keyword.for("args")]), construct_vector.call(Chomp, [Keyword.for("close_p")])]))(tokens);}
function parse_record_lookup(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [construct_vector.call(AbortIf, [not_adjacent__q]), Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("record_lookup"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("open_b")]), construct_vector.call(Until, [Keyword.for("close_b"), parse_record_entry, Keyword.for("entries")]), construct_vector.call(Chomp, [Keyword.for("close_b")])]))(tokens, lhs);}
function parse_dynamic_access(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [construct_vector.call(AbortIf, [not_adjacent__q]), Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("dynamic_access"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("open_sq")]), construct_vector.call(Until, [Keyword.for("close_sq"), parse_expr, Keyword.for("exprs")]), construct_vector.call(Chomp, [Keyword.for("close_sq")])]))(tokens);}
let assignable_ops = concat.bind(math_ops)([Keyword.for("or_or"), Keyword.for("and_and")]);
function parse_op_eq(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("op_eq"), 'lhs':lhs})), construct_vector.call(Either, [assignable_ops, Keyword.for("op")]), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("rhs")])]))(tokens);}
function parse_raw_dynamic_access(tokens, lhs) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("raw_dynamic_access"), 'lhs':lhs})), construct_vector.call(Chomp, [Keyword.for("dot"), Keyword.for("open_sq")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), construct_vector.call(Chomp, [Keyword.for("close_sq")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("multi_decorator")})), construct_vector.call(Chomp, [Keyword.for("at"), Keyword.for("open_sq")]), construct_vector.call(Until, [Keyword.for("close_sq"), parse_decorator_expr, Keyword.for("decorators")]), construct_vector.call(Chomp, [Keyword.for("close_sq")]), construct_vector.call(Then, [parse_fn, Keyword.for("fn_def")])]))(tokens);}
function parse_decorator(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("decorator")})), construct_vector.call(Chomp, [Keyword.for("at")]), construct_vector.call(One, [Keyword.for("id"), Keyword.for("name")]), construct_vector.call(Optional, [Keyword.for("open_p"), parse_call_expr, Keyword.for("args")]), construct_vector.call(Then, [parse_fn, Keyword.for("fn_def")])]))(tokens);}
let parse_regex = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("regex_lit")})), construct_vector.call(One, [Keyword.for("regex_lit"), Keyword.for("value")])]);
let parse_str = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("str")})), construct_vector.call(One, [Keyword.for("string_lit"), Keyword.for("value")])]);
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("reg_obj_entry")})), construct_vector.call(Either, [Set[Meta]['[]'].call(Set, Keyword.for("id"), Keyword.for("num")), Keyword.for("key")]), construct_vector.call(Chomp, [Keyword.for("colon")]), construct_vector.call(Then, [parse_expr, Keyword.for("value")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("dynamic_obj_entry")})), construct_vector.call(Chomp, [Keyword.for("open_sq")]), construct_vector.call(Then, [parse_expr, Keyword.for("key_expr")]), construct_vector.call(Chomp, [Keyword.for("close_sq"), Keyword.for("colon")]), construct_vector.call(Then, [parse_expr, Keyword.for("value")])]))(tokens);}
function parse_spread_obj_entry(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("spread_obj_entry")})), construct_vector.call(Chomp, [Keyword.for("dot_dot_dot")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("obj_lit")})), construct_vector.call(Chomp, [Keyword.for("open_b")]), construct_vector.call(Until, [Keyword.for("close_b"), parse_obj_entry, Keyword.for("entries")]), construct_vector.call(Chomp, [Keyword.for("close_b")])]))(tokens);}
let parse_spread_assign = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("spread_assign")})), construct_vector.call(Chomp, [Keyword.for("dot_dot_dot")]), construct_vector.call(Either, [valid_ids_in_all_contexts, Keyword.for("name")])]);
...
let parse_assign_array = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("array_deconstruction")})), construct_vector.call(Chomp, [Keyword.for("open_sq")]), construct_vector.call(Until, [Keyword.for("close_sq"), parse_assign_array_entry, Keyword.for("entries")]), construct_vector.call(Chomp, [Keyword.for("close_sq")])]);
let parse_obj_entry_rename = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("obj_entry_rename")})), construct_vector.call(Either, [valid_ids_in_all_contexts, Keyword.for("old_name")]), construct_vector.call(Chomp, [Keyword.for("colon")]), construct_vector.call(Either, [valid_ids_in_all_contexts, Keyword.for("new_name")])]);
...
let parse_string_obj_assign_entry = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("obj_str_rename_entry")})), construct_vector.call(One, [Keyword.for("string_lit"), Keyword.for("old_name")]), construct_vector.call(Chomp, [Keyword.for("colon")]), construct_vector.call(Either, [valid_ids_in_all_contexts, Keyword.for("new_name")])]);
...
let parse_assign_obj = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("object_deconstruction")})), construct_vector.call(Chomp, [Keyword.for("open_b")]), construct_vector.call(Until, [Keyword.for("close_b"), parse_obj_assign_entry, Keyword.for("entries")]), construct_vector.call(Chomp, [Keyword.for("close_b")])]);
let parse_this_assign = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("this_assign")})), construct_vector.call(Chomp, [Keyword.for("at")]), construct_vector.call(Either, [valid_ids_in_all_contexts, Keyword.for("name")])]);
...
let parse_keyword = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("keyword")})), construct_vector.call(One, [Keyword.for("keyword"), Keyword.for("value")])]);
function parse_paren_expr(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("paren_expr")})), construct_vector.call(Chomp, [Keyword.for("open_p")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), construct_vector.call(Chomp, [Keyword.for("close_p")])]))(tokens);}
function parse_yield(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("yield")})), construct_vector.call(Chomp, [Keyword.for("yield")]), construct_vector.call(Optional, [Keyword.for("times"), parse_gen_modifier, Keyword.for("star?")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
function parse_await(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("await")})), construct_vector.call(Chomp, [Keyword.for("await")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
let parse_num = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("num")})), construct_vector.call(One, [Keyword.for("num"), Keyword.for("value")])]);
let parse_custom_number_literal = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("custom_number_literal")})), construct_vector.call(One, [Keyword.for("custom_number_literal"), Keyword.for("value")])]);
function parse_array(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("array")})), construct_vector.call(Chomp, [Keyword.for("open_sq")]), construct_vector.call(Until, [Keyword.for("close_sq"), parse_expr, Keyword.for("elements")]), construct_vector.call(Chomp, [Keyword.for("close_sq")])]))(tokens);}
function parse_spread(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("spread")})), construct_vector.call(Chomp, [Keyword.for("dot_dot_dot")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("bind_this")})), construct_vector.call(Chomp, [Keyword.for("double_colon")]), construct_vector.call(Case, [construct_record.call(ParseMap, [[Keyword.for("id"), parse_id], [Keyword.for("fn"), parse_fn], [all_math_ops, parse_unapplied_math_op], [Keyword.for("open_p"), parse_paren_expr]]), Keyword.for("expr")])]))(tokens);}
function parse_not(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("not")})), construct_vector.call(Chomp, [Keyword.for("bang")]), construct_vector.call(Then, [parse_1_2_expr, Keyword.for("expr")])]))(tokens);}
function parse_new(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("new")})), construct_vector.call(Chomp, [Keyword.for("new")]), construct_vector.call(One, [Keyword.for("id"), Keyword.for("constructor_name")]), construct_vector.call(Chomp, [Keyword.for("open_p")]), construct_vector.call(Until, [Keyword.for("close_p"), parse_expr, Keyword.for("args")]), construct_vector.call(Chomp, [Keyword.for("close_p")])]))(tokens);}
...
let parse_anon_arg_id = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("anon_arg_id")})), construct_vector.call(Chomp, [Keyword.for("single_and")]), construct_vector.call(Optional, [Keyword.for("num"), parse_adjacent_num_raw, Keyword.for("arg_num")])]);
let parse_unapplied_and_and = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("unapplied_and_and")})), construct_vector.call(Chomp, [Keyword.for("and_and")])]);
let parse_unapplied_or_or = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("unapplied_or_or")})), construct_vector.call(Chomp, [Keyword.for("or_or")])]);
function parse_shorthand_anon_fn(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("shorthand_anon_fn")})), construct_vector.call(Chomp, [Keyword.for("hash"), Keyword.for("open_p")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), construct_vector.call(Chomp, [Keyword.for("close_p")])]))(tokens);}
let parse_async_modifier = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, true), construct_vector.call(Chomp, [Keyword.for("async")])]);
let parse_gen_modifier = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, true), construct_vector.call(Chomp, [Keyword.for("times")])]);
function parse_fn_expr_body(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("return")})), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), construct_vector.call(FMap, [function (node) {
return [node];}])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("fn")})), construct_vector.call(Optional, [Keyword.for("async"), parse_async_modifier, Keyword.for("is_async?")]), construct_vector.call(Chomp, [Keyword.for("fn")]), construct_vector.call(Optional, [Keyword.for("times"), parse_gen_modifier, Keyword.for("generator?")]), construct_vector.call(Optional, [Keyword.for("id"), parse_fn_name, Keyword.for("name")]), construct_vector.call(Optional, [Keyword.for("open_p"), parse_args_def, Keyword.for("args")]), construct_vector.call(Case, [construct_record.call(ParseMap, [[Keyword.for("eq"), parse_fn_expr_body], [Keyword.for("open_b"), block()]]), Keyword.for("body")])]))(tokens);}
function parse_keyword_record_entry(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("keyword_record_entry")})), construct_vector.call(One, [Keyword.for("id"), Keyword.for("name")]), construct_vector.call(Chomp, [Keyword.for("colon")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
function parse_regular_record_entry(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("regular_record_entry")})), construct_vector.call(Then, [parse_expr, Keyword.for("key_expr")]), construct_vector.call(Chomp, [Keyword.for("arrow")]), construct_vector.call(Then, [parse_expr, Keyword.for("value_expr")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("record_syntax")})), construct_vector.call(Chomp, [Keyword.for("open_b")]), construct_vector.call(Until, [Keyword.for("close_b"), parse_record_entry, Keyword.for("entries")]), construct_vector.call(Chomp, [Keyword.for("close_b")])]))(tokens);}
function parse_vector_syntax(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("vector_syntax")})), construct_vector.call(Chomp, [Keyword.for("open_sq")]), construct_vector.call(Until, [Keyword.for("close_sq"), parse_expr, Keyword.for("entries")]), construct_vector.call(Chomp, [Keyword.for("close_sq")])]))(tokens);}
function parse_custom_data_syntax(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("custom_data_literal")})), construct_vector.call(Chomp, [Keyword.for("tilde")]), construct_vector.call(Then, [parse_single_expr, Keyword.for("constructor_expr")]), construct_vector.call(Case, [construct_record.call(ParseMap, [[Keyword.for("open_sq"), parse_vector_syntax], [Keyword.for("open_b"), parse_record_syntax]]), Keyword.for("data")])]))(tokens);}
function parse_set(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("set")})), construct_vector.call(Chomp, [Keyword.for("hash"), Keyword.for("open_b")]), construct_vector.call(Until, [Keyword.for("close_b"), parse_expr, Keyword.for("elements")]), construct_vector.call(Chomp, [Keyword.for("close_b")])]))(tokens);}
function parse_prefix_exclusive_range(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("prefix_exclusive_range")})), construct_vector.call(Chomp, [Keyword.for("dot_dot")]), construct_vector.call(Then, [parse_1_2_expr, Keyword.for("expr")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("else")})), construct_vector.call(Chomp, [Keyword.for("else")]), block(Keyword.for("body"))]))(tokens);}
function parse_else_if_branch(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("else_if")})), construct_vector.call(Chomp, [Keyword.for("else"), Keyword.for("if")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), block(Keyword.for("pass")), construct_vector.call(Optional, [Keyword.for("else"), parse_if_branch, Keyword.for("fail")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("if")})), construct_vector.call(Chomp, [Keyword.for("if")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), block(Keyword.for("pass")), construct_vector.call(Optional, [Keyword.for("else"), parse_if_branch, Keyword.for("fail")])]))(tokens);}
let parse_let = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("let")})), construct_vector.call(Chomp, [Keyword.for("let")]), construct_vector.call(Then, [parse_assign_expr, Keyword.for("assign_expr")]), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("rhs")])]);
function parse_if_let(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("if_let")})), construct_vector.call(Chomp, [Keyword.for("if"), Keyword.for("let")]), construct_vector.call(Then, [parse_assign_expr, Keyword.for("assign_expr")]), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")]), construct_vector.call(Chomp, [Keyword.for("open_b")]), construct_vector.call(Until, [Keyword.for("close_b"), parse_statement, Keyword.for("pass")]), construct_vector.call(Chomp, [Keyword.for("close_b")]), construct_vector.call(Optional, [Keyword.for("else"), parse_else_branch, Keyword.for("fail")])]))(tokens);}
let parse_impl_for = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("impl_for")})), construct_vector.call(Chomp, [Keyword.for("impl")]), construct_vector.call(Then, [parse_expr, Keyword.for("proto_expr")]), construct_vector.call(Chomp, [Keyword.for("for")]), construct_vector.call(One, [Keyword.for("id"), Keyword.for("constructor")]), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]);
let parse_define = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("define_for")})), construct_vector.call(Chomp, [Keyword.for("define")]), construct_vector.call(Then, [parse_expr, Keyword.for("proto_expr")]), construct_vector.call(Chomp, [Keyword.for("for")]), construct_vector.call(Then, [parse_single_expr, Keyword.for("src_expr")]), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]);
let parse_protocol = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("protocol_def")})), construct_vector.call(Chomp, [Keyword.for("protocol")]), construct_vector.call(One, [Keyword.for("id"), Keyword.for("name")])]);
let parse_return = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("return")})), construct_vector.call(Chomp, [Keyword.for("return")]), construct_vector.call(Optional, [keys.bind(SINGLE_EXPR_PARSE_MAP)(), parse_expr, Keyword.for("expr")])]);
let parse_await_modifier = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, true), construct_vector.call(Chomp, [Keyword.for("await")])]);
function parse_for_loop(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("for_loop")})), construct_vector.call(Chomp, [Keyword.for("for")]), construct_vector.call(Optional, [Keyword.for("await"), parse_await_modifier, Keyword.for("is_await?")]), construct_vector.call(Then, [parse_assign_expr, Keyword.for("assign_expr")]), construct_vector.call(Chomp, [Keyword.for("of")]), construct_vector.call(Then, [parse_expr, Keyword.for("iterable_expr")]), block(Keyword.for("body"))]))(tokens);}
function parse_loop(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("loop")})), construct_vector.call(Chomp, [Keyword.for("loop")]), block(Keyword.for("body"))]))(tokens);}
function parse_while_loop(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("while_loop")})), construct_vector.call(Chomp, [Keyword.for("while")]), construct_vector.call(Then, [parse_expr, Keyword.for("test_expr")]), block(Keyword.for("body"))]))(tokens);}
function parse_while_let_loop(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("while_let_loop")})), construct_vector.call(Chomp, [Keyword.for("while"), Keyword.for("let")]), construct_vector.call(Then, [parse_assign_expr, Keyword.for("assign_expr")]), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("test_expr")]), block(Keyword.for("body"))]))(tokens);}
function parse_continue(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("continue")})), construct_vector.call(Chomp, [Keyword.for("continue")])]))(tokens);}
function parse_break(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("break")})), construct_vector.call(Chomp, [Keyword.for("break")])]))(tokens);}
function parse_catch(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("catch")})), construct_vector.call(Chomp, [Keyword.for("catch")]), construct_vector.call(One, [Keyword.for("id"), Keyword.for("name")]), block(Keyword.for("body"))]))(tokens);}
function parse_finally(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("finally")})), construct_vector.call(Chomp, [Keyword.for("finally")]), block(Keyword.for("body"))]))(tokens);}
function parse_try(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("try")})), construct_vector.call(Chomp, [Keyword.for("try")]), block(Keyword.for("body")), construct_vector.call(Optional, [Keyword.for("catch"), parse_catch, Keyword.for("catch")]), construct_vector.call(Optional, [Keyword.for("finally"), parse_finally, Keyword.for("finally")])]))(tokens);}
let parse_impl_object = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("impl_object")})), construct_vector.call(Chomp, [Keyword.for("impl")]), construct_vector.call(One, [Keyword.for("id"), Keyword.for("constructor")]), construct_vector.call(Chomp, [Keyword.for("eq")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]);
let parse_assign_all_as = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("assign_all_as")})), construct_vector.call(Chomp, [Keyword.for("times"), Keyword.for("as")]), construct_vector.call(One, [Keyword.for("id"), Keyword.for("name")])]);
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("import")})), construct_vector.call(Chomp, [Keyword.for("import")]), construct_vector.call(Until, [Keyword.for("from"), parse_import_assign_expr, Keyword.for("assign_exprs")]), construct_vector.call(Chomp, [Keyword.for("from")]), construct_vector.call(Then, [parse_str, Keyword.for("path")])]))(tokens);}
function parse_export(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("export")})), construct_vector.call(Chomp, [Keyword.for("export")]), construct_vector.call(Then, [parse_statement, Keyword.for("statement")])]))(tokens);}
let parse_export_all = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("export_all")})), construct_vector.call(Chomp, [Keyword.for("export"), Keyword.for("times"), Keyword.for("from")]), construct_vector.call(One, [Keyword.for("string_lit"), Keyword.for("path")])]);
function parse_export_default(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("export_default")})), construct_vector.call(Chomp, [Keyword.for("export"), Keyword.for("default")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
function parse_label(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("label")})), construct_vector.call(One, [Keyword.for("id"), Keyword.for("label_name")]), construct_vector.call(Chomp, [Keyword.for("colon")]), construct_vector.call(Then, [parse_statement, Keyword.for("statement")])]))(tokens);}
...
return str("F => ", eval_expr(lhs), "(F", pipe.bind(len.bind(args)())(construct_record.call(Map, [[(0), ""]]), or.call(_, () => ", ")), map_join.bind(args)(eval_expr, ", "), ")");
};}))(", "))(function (decorators) {
