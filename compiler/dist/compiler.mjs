...
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("keyof"), 'lhs':lhs})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("keyof")), Then[Meta]['[]'].call(Then, parse_expr, Keyword.for("rhs"))))(tokens);}
...
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("bind"), 'lhs':lhs})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("double_colon")), Case[Meta]['[]'].call(Case, ParseMap[Meta]['{}'].call(ParseMap, [[Keyword.for("id"), parse_id], [Keyword.for("fn"), parse_fn], [[Keyword.for("tilde"), Keyword.for("id"), Keyword.for("open_b")], parse_record_syntax], [all_math_ops, parse_unapplied_math_op], [Keyword.for("open_p"), parse_paren_expr]]), Keyword.for("expr"))))(tokens);}
...
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("new")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("new")), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("constructor_name")), Chomp[Meta]['[]'].call(Chomp, Keyword.for("open_p")), Until[Meta]['[]'].call(Until, Keyword.for("close_p"), parse_expr, Keyword.for("args")), Chomp[Meta]['[]'].call(Chomp, Keyword.for("close_p"))))(tokens);}
...
let parse_anon_arg_id = Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("anon_arg_id")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("single_and")), Optional[Meta]['[]'].call(Optional, Keyword.for("num"), parse_adjacent_num_raw, Keyword.for("arg_num")));
...
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("shorthand_anon_fn")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("hash"), Keyword.for("open_p")), Then[Meta]['[]'].call(Then, parse_expr, Keyword.for("expr")), Chomp[Meta]['[]'].call(Chomp, Keyword.for("close_p"))))(tokens);}
...
return call.bind(ParseMap[Meta]['{}'].call(ParseMap, [[[Keyword.for("id"), Keyword.for("colon")], parse_keyword_record_entry], [_, parse_regular_record_entry]]))(tokens);}
function parse_record_syntax(tokens) {
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("record_syntax")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("open_b")), Until[Meta]['[]'].call(Until, Keyword.for("close_b"), parse_record_entry, Keyword.for("entries")), Chomp[Meta]['[]'].call(Chomp, Keyword.for("close_b"))))(tokens);}
function parse_vector_syntax(tokens) {
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("vector_syntax")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("open_sq")), Until[Meta]['[]'].call(Until, Keyword.for("close_sq"), parse_expr, Keyword.for("entries")), Chomp[Meta]['[]'].call(Chomp, Keyword.for("close_sq"))))(tokens);}
function parse_custom_data_syntax(tokens) {
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("custom_data_literal")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("tilde")), Then[Meta]['[]'].call(Then, parse_single_expr, Keyword.for("constructor_expr")), Case[Meta]['[]'].call(Case, ParseMap[Meta]['{}'].call(ParseMap, [[Keyword.for("open_sq"), parse_vector_syntax], [Keyword.for("open_b"), parse_record_syntax]]), Keyword.for("data"))))(tokens);}
function parse_set(tokens) {
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("set")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("hash"), Keyword.for("open_b")), Until[Meta]['[]'].call(Until, Keyword.for("close_b"), parse_expr, Keyword.for("elements")), Chomp[Meta]['[]'].call(Chomp, Keyword.for("close_b"))))(tokens);}
...
return call.bind(pipe.bind(at.bind(node)(Keyword.for("type")))(Map[Meta]['{}'].call(Map, [[Keyword.for("obj_reg_entry"), eval_obj_reg_entry], [Keyword.for("obj_entry_rename"), eval_obj_entry_rename], [Keyword.for("spread_assign"), eval_spread_assign], [Keyword.for("obj_str_rename_entry"), (...__args) => str(at.bind(__args[0])(Keyword.for("old_name")), ": ", resolve_name(at.bind(__args[0])(Keyword.for("new_name"))))]])))(node);}
...
return call.bind(pipe.bind(at.bind(node)(Keyword.for("type")))(Map[Meta]['{}'].call(Map, [[Keyword.for("regular_record_entry"), eval_regular_record_entry], [Keyword.for("keyword_record_entry"), eval_keyword_record_entry]])))(node);}
