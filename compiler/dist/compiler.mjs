...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("property_lookup"), 'lhs':lhs})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("dot")), construct_vector.call(Either, [Set[Meta]['[]'].call(Set, Keyword.for("id"), Keyword.for("from")), Keyword.for("property")])]))(tokens);}
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("break")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("break"))]))(tokens);}
function parse_catch(tokens) {
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("catch")})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("catch")), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("name")), block(Keyword.for("body"))]))(tokens);}
