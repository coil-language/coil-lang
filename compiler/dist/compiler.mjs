...
function parse_pipe_to_operator(tokens, lhs) {
return call.bind(Parser[Meta]['[]'].call(Parser, Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("pipe_to"), 'lhs':lhs})), Chomp[Meta]['[]'].call(Chomp, Keyword.for("fn_pipe")), Then[Meta]['[]'].call(Then, parse_1_2_expr, Keyword.for("rhs"))))(tokens);}
...
let eval_pipe_to = str['kw']("call.call(", compose(Keyword.for("rhs"), eval_expr), ", ", compose(Keyword.for("lhs"), eval_expr), ")");
