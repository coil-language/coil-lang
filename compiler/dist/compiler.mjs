...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("yield")})), construct_vector.call(Chomp, [Keyword.for("yield")]), Optional[Meta]['[]'].call(Optional, Keyword.for("times"), parse_gen_modifier, Keyword.for("star?")), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
...
let parse_anon_arg_id = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("anon_arg_id")})), construct_vector.call(Chomp, [Keyword.for("single_and")]), Optional[Meta]['[]'].call(Optional, Keyword.for("num"), parse_adjacent_num_raw, Keyword.for("arg_num"))]);
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("keyword_record_entry")})), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("name")), construct_vector.call(Chomp, [Keyword.for("colon")]), construct_vector.call(Then, [parse_expr, Keyword.for("expr")])]))(tokens);}
...
let parse_protocol = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("protocol_def")})), construct_vector.call(Chomp, [Keyword.for("protocol")]), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("name"))]);
let parse_return = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("return")})), construct_vector.call(Chomp, [Keyword.for("return")]), Optional[Meta]['[]'].call(Optional, keys.bind(SINGLE_EXPR_PARSE_MAP)(), parse_expr, Keyword.for("expr"))]);
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("catch")})), construct_vector.call(Chomp, [Keyword.for("catch")]), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("name")), block(Keyword.for("body"))]))(tokens);}
...
let parse_assign_all_as = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("assign_all_as")})), construct_vector.call(Chomp, [Keyword.for("times"), Keyword.for("as")]), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("name"))]);
...
let parse_export_all = construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("export_all")})), construct_vector.call(Chomp, [Keyword.for("export"), Keyword.for("times"), Keyword.for("from")]), One[Meta]['[]'].call(One, Keyword.for("string_lit"), Keyword.for("path"))]);
...
return call.bind(construct_vector.call(Parser, [Init[Meta]['[]'].call(Init, new ObjectLiteral({'type': Keyword.for("label")})), One[Meta]['[]'].call(One, Keyword.for("id"), Keyword.for("label_name")), construct_vector.call(Chomp, [Keyword.for("colon")]), construct_vector.call(Then, [parse_statement, Keyword.for("statement")])]))(tokens);}
