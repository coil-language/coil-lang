...
CollectionView["prototype"][dot(Collection, "len")] = function () {
  let __coil_temp;
  return dot(dot(this, "collection"), len)
    [invoke]()
    [Algebra["-"]](dot(this, "idx"));
};
...
CollectionView["prototype"]["skip"] = function (n) {
  ...
  return CollectionView[Meta.create]([
    dot(this, "collection"),
    dot(this, "idx")[Algebra["+"]](n),
  ]);
};
CollectionView["prototype"][dot(Symbol, "iterator")] = function* () {
  let __coil_temp;
  for (let i of new ExclusiveRange(
    dot(this, "idx"),
    dot(dot(this, "collection"), len)[invoke]()
  )) {
    let __coil_temp;
...
Lexer["prototype"][invoke] = function (str) {
  ...
  let scan = function (pattern) {
    ...
    if (
      ((__coil_temp = { left: dot(result, nil__q)[invoke]() }),
      __coil_temp.left[Meta.as_bool]()
        ? __coil_temp.left
        : dot(result, "index")[Meta["!="]](0))[Meta.as_bool]()
    ) {
      let __coil_temp;
      return false;
    } else {
...
let expect_token__b = function (tokens, kw) {
  ...
  if (
    dot(dot(tokens, first)[invoke](), at)
      [invoke](Keyword.for("type"))
      [Meta["!="]](kw)
      [Meta.as_bool]()
  ) {
    let __coil_temp;
    raise__b[invoke](
      ParseError[Meta.create]([kw, dot(tokens, first)[invoke]()])
    );
  } else {
    let __coil_temp;
    return tokens;
...
let verify_exists__b = function (expr, parser) {
  ...
  if (dot(expr, nil__q)[invoke]()[Meta.as_bool]()) {
    let __coil_temp;
    raise__b[invoke](
      Error[Meta.create](["Parser Failed - Expected "[Algebra["+"]](parser)])
    );
  } else {
    let __coil_temp;
    return expr;
...
Init["prototype"][parse] = function ([_expr, tokens]) {
  ...
  return [
    ObjectLiteral[Meta.from_entries]([
      ...dot(this, "expr"),
      [Keyword.for("pos"), line_and_col[invoke](dot(tokens, first)[invoke]())],
    ]),
    tokens,
  ];
};
...
One["prototype"][parse] = function ([expr, tokens]) {
  ...
  return [
    ObjectLiteral[Meta.from_entries]([...expr, [dot(this, "as"), value]]),
    dot(tokens, "skip")[invoke](1),
  ];
};
...
Optional["prototype"][parse] = function ([expr, tokens]) {
  ...
  if (dot(tokens, empty__q)[invoke]()[Meta.as_bool]()) {
    ...
    return dot(
      Then[Meta.create]([
        dot(this, Keyword.for("parse_fn")),
        dot(this, Keyword.for("as")),
      ]),
      parse
    )[invoke]([expr, tokens]);
  } else {
...
Until["prototype"][parse] = function ([expr, tokens]) {
  ...
  while (
    dot(dot(tokens, first)[invoke](), at)
      [invoke](Keyword.for("type"))
      [Meta["!="]](dot(this, "end_kw"))
      [Meta.as_bool]()
  ) {
    let __coil_temp;
    let [expr, new_tokens] = verify_exists__b[invoke](
      dot(this, "parser")[invoke](tokens),
      this
    );
  ...
  if (dot(this, "kw")[Meta.as_bool]()) {
    let __coil_temp;
    return [
      ObjectLiteral[Meta.from_entries]([...expr, [dot(this, "kw"), exprs]]),
      tokens,
    ];
  } else {
    let __coil_temp;
...
UntilEither["prototype"][parse] = function ([expr, tokens]) {
  ...
  while (
    dot(
      dot(dot(tokens, first)[invoke](), at)[invoke](Keyword.for("type")),
      pipe
    )
      [invoke](dot(this, "set"))
      [Bool.negate]()
...
Case["prototype"][parse] = function ([expr, tokens]) {
  ...
  if (__coil_if_let_temp[Meta.as_bool]()) {
    ...
    let __coil_temp;
    dot(console, log)[invoke](
      dot(dot(this, "tokens"), first)[invoke](),
      dot(this, "parse_map")
    );
...
Either["prototype"][parse] = function ([expr, tokens]) {
  ...
  let [new_expr, rest] = [
    dot(tokens, first)[invoke](),
    dot(tokens, "skip")[invoke](1),
  ];
  return [
    ObjectLiteral[Meta.from_entries]([
      ...expr,
      [dot(this, "kw"), dot(new_expr, at)[invoke](Keyword.for("value"))],
    ]),
    rest,
  ];
};
...
ParseMap["prototype"][dot(Record, "keys")] = function () {
  let __coil_temp;
  return dot(
    dot(dot(this, "entries"), map)[invoke](([pattern, _]) => pattern),
    into
...
let algebra_ops = Set[Meta.create]([
  Keyword.for("mod"),
  Keyword.for("plus"),
  Keyword.for("minus"),
  Keyword.for("times"),
...
let parse_dot = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("dot")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("dot")]),
    Then[Meta.create]([parse_single_expr, Keyword.for("rhs")]),
  ])[invoke](tokens);
};
let parse_keyword_lookup = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    ...
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("keyword_lookup")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    ...
    FMap[Meta.create]([
      ({ lhs: lhs, type: type, property: property }) =>
        ObjectLiteral[Meta.from_entries]([
          [Keyword.for("lhs"), lhs],
          [Keyword.for("type"), type],
          [Keyword.for("property"), dot(property, "slice")[invoke](1)],
        ]),
    ]),
  ])[invoke](tokens);
};
let not_adjacent__q = function ([_expr, tokens]) {
  ...
  if (dot(current, "line")[Meta["!="]](dot(previous, "line"))[Meta.as_bool]()) {
    ...
    let __coil_temp;
    let end_of_prev_token = dot(previous, "col")[Algebra["+"]](
      dot(dot(previous, "value"), "length")
    );
    return dot(current, "col")
      [Algebra["-"]](end_of_prev_token)
      [Algebra[">="]](1);
  }
};
...
let parse_inclusive_range = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    ...
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("inclusive_range")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("dot_dot"), Keyword.for("eq")]),
    Optional[Meta.create]([
      dot(SINGLE_EXPR_PARSE_MAP, keys)[invoke](),
      parse_adjacent_expr,
      Keyword.for("rhs"),
    ]),
  ])[invoke](tokens);
...
let parse_exclusive_range = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    ...
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("exclusive_range")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("dot_dot")]),
    Optional[Meta.create]([
      dot(SINGLE_EXPR_PARSE_MAP, keys)[invoke](),
      parse_adjacent_expr,
      Keyword.for("rhs"),
...
let parse_fn_call = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    ...
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("fn_call")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    ...
    Chomp[Meta.create]([Keyword.for("close_p")]),
  ])[invoke](tokens);
};
let parse_meta_from_entries = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    ...
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("meta_from_entries")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
...
let parse_meta_create = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    ...
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("meta_create")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("open_sq")]),
    Until[Meta.create]([
      Keyword.for("close_sq"),
      parse_expr,
      Keyword.for("entries"),
    ]),
    Chomp[Meta.create]([Keyword.for("close_sq")]),
  ])[invoke](tokens, lhs);
};
...
let parse_algebra_op = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("algebra_op")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Either[Meta.create]([algebra_ops, Keyword.for("op")]),
    Then[Meta.create]([parse_1_2_expr, Keyword.for("rhs")]),
  ])[invoke](tokens);
};
...
let parse_eq_op = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("equality_op")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Either[Meta.create]([
      Set[Meta.create]([Keyword.for("double_eq"), Keyword.for("not_eq")]),
      Keyword.for("op"),
    ]),
    Then[Meta.create]([parse_1_2_3_expr, Keyword.for("rhs")]),
  ])[invoke](tokens);
};
...
let parse_and = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("and")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("and")]),
    Then[Meta.create]([parse_1_2_3_4_expr, Keyword.for("rhs")]),
  ])[invoke](tokens);
};
let parse_or = function (tokens, lhs) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("or")],
        [Keyword.for("lhs"), lhs],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("or")]),
    Then[Meta.create]([parse_1_2_3_4_expr, Keyword.for("rhs")]),
  ])[invoke](tokens);
};
...
let parse_regex = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("regex_lit")],
    ]),
  ]),
  One[Meta.create]([Keyword.for("regex_lit"), Keyword.for("value")]),
]);
let parse_str = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("str")],
    ]),
  ]),
  One[Meta.create]([Keyword.for("string_lit"), Keyword.for("value")]),
]);
let valid_ids_in_all_contexts = Set[Meta.create]([
  Keyword.for("id"),
  Keyword.for("from"),
]);
let parse_id = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("id_lookup")],
    ]),
  ]),
  Either[Meta.create]([
    Set[Meta.create]([...valid_ids_in_all_contexts, Keyword.for("import")]),
    Keyword.for("name"),
  ]),
]);
let parse_obj = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("object_literal")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("open_b")]),
    Until[Meta.create]([
...
let parse_spread_assign = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("spread_assign")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("dot_dot_dot")]),
  Either[Meta.create]([valid_ids_in_all_contexts, Keyword.for("name")]),
]);
let parse_assign_id = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("id_assign")],
    ]),
  ]),
  Either[Meta.create]([valid_ids_in_all_contexts, Keyword.for("name")]),
]);
let parse_assign_array = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("array_deconstruction")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("open_sq")]),
    Until[Meta.create]([
...
let parse_obj_entry_rename = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("obj_entry_rename")],
    ]),
  ]),
  Either[Meta.create]([valid_ids_in_all_contexts, Keyword.for("old_name")]),
  Chomp[Meta.create]([Keyword.for("colon")]),
  Either[Meta.create]([valid_ids_in_all_contexts, Keyword.for("new_name")]),
]);
let parse_regular_obj_assign_entry = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("obj_reg_entry")],
    ]),
  ]),
  Either[Meta.create]([valid_ids_in_all_contexts, Keyword.for("name")]),
]);
let parse_obj_entry_destructure = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("obj_assign_expr")],
      ]),
    ]),
    One[Meta.create]([valid_ids_in_all_contexts, Keyword.for("property")]),
    Chomp[Meta.create]([Keyword.for("colon")]),
    Then[Meta.create]([parse_assign_expr, Keyword.for("assign_expr")]),
  ])[invoke](tokens);
};
let parse_obj_assign_entry = ParseMap[Meta.from_entries]([
  [
...
let parse_assign_obj = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("object_deconstruction")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("open_b")]),
  Until[Meta.create]([
...
let parse_this_assign = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("this_assign")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("at")]),
  Either[Meta.create]([valid_ids_in_all_contexts, Keyword.for("name")]),
]);
let parse_this_spread_assign = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("this_spread_assign")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("dot_dot_dot"), Keyword.for("at")]),
  One[Meta.create]([Keyword.for("id"), Keyword.for("name")]),
]);
let parse_assign_expr = ParseMap[Meta.from_entries]([
...
let parse_paren_expr = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("paren_expr")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("open_p")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
    Chomp[Meta.create]([Keyword.for("close_p")]),
  ])[invoke](tokens);
};
let parse_yield = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("yield")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("yield")]),
    Optional[Meta.create]([
      Keyword.for("times"),
      parse_gen_modifier,
      Keyword.for("star?"),
...
let parse_await = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("await")],
      ]),
    ]),
...
let parse_num = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("num")],
    ]),
  ]),
...
let parse_array = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("array")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("open_sq")]),
    Until[Meta.create]([
...
let parse_spread = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("spread")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("dot_dot_dot")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
...
let parse_not = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("not")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("bang")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
  ])[invoke](tokens);
};
...
let parse_adjacent_num_raw = Parser[Meta.create]([
  AbortIf[Meta.create]([not_adjacent__q]),
...
let parse_fn_expr_body = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("return")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("eq")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
    FMap[Meta.create]([(node) => [node]]),
  ])[invoke](tokens);
};
let parse_args_def = function (tokens) {
  ...
  return Parser[Meta.create]([
    Chomp[Meta.create]([Keyword.for("open_p")]),
    Until[Meta.create]([Keyword.for("close_p"), parse_assign_expr]),
    Chomp[Meta.create]([Keyword.for("close_p")]),
  ])[invoke](tokens);
};
let parse_name_expr = function (tokens) {
  ...
  if (__coil_if_let_temp[Meta.as_bool]()) {
    ...
    let __coil_temp;
    let parse_map = ParseMap[Meta.from_entries]([
      [Keyword.for("dot"), parse_dot],
      [Keyword.for("keyword"), parse_keyword_lookup],
    ]);
...
let parse_fn = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("fn")],
      ]),
    ]),
    Optional[Meta.create]([
      Keyword.for("async"),
    ...
    Chomp[Meta.create]([Keyword.for("fn")]),
    Optional[Meta.create]([
      Keyword.for("times"),
      parse_gen_modifier,
      Keyword.for("generator?"),
    ]),
    Then[Meta.create]([parse_name_expr, Keyword.for("name_expr")]),
    Optional[Meta.create]([
      Keyword.for("open_p"),
      parse_args_def,
      Keyword.for("args"),
...
let parse_keyword_record_entry = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("keyword_record_entry")],
      ]),
    ]),
    One[Meta.create]([Keyword.for("id"), Keyword.for("name")]),
    Chomp[Meta.create]([Keyword.for("colon")]),
...
let parse_regular_record_entry = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("regular_record_entry")],
      ]),
    ]),
    Then[Meta.create]([parse_expr, Keyword.for("key_expr")]),
    Chomp[Meta.create]([Keyword.for("arrow")]),
    Then[Meta.create]([parse_expr, Keyword.for("value_expr")]),
  ])[invoke](tokens);
};
...
let parse_prefix_inclusive_range = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("prefix_inclusive_range")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("dot_dot"), Keyword.for("eq")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
...
let parse_prefix_exclusive_range = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("prefix_exclusive_range")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("dot_dot")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
...
let parse_keyword = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("keyword")],
      ]),
    ]),
    One[Meta.create]([Keyword.for("keyword"), Keyword.for("value")]),
    FMap[Meta.create]([
      ({ type: type, value: value }) =>
        ObjectLiteral[Meta.from_entries]([
          [Keyword.for("type"), type],
          [Keyword.for("value"), dot(value, "slice")[invoke](1)],
        ]),
    ]),
  ])[invoke](tokens);
};
let parse_anon_fn = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("anon_fn")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("pipe_bar")]),
    Until[Meta.create]([
      Keyword.for("pipe_bar"),
      parse_assign_expr,
      Keyword.for("args"),
    ...
    Chomp[Meta.create]([Keyword.for("pipe_bar")]),
    Then[Meta.create]([parse_expr, Keyword.for("return_expr")]),
  ])[invoke](tokens);
};
let parse_reassign = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("reassign")],
      ]),
    ]),
    One[Meta.create]([Keyword.for("id"), Keyword.for("name")]),
    Chomp[Meta.create]([Keyword.for("eq")]),
...
let SINGLE_EXPR_PARSE_MAP = ParseMap[Meta.from_entries]([
...
let parse_else_branch = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("else")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("else")]),
    UntilEither[Meta.create]([
      Set[Meta.create]([Keyword.for("else"), Keyword.for("end")]),
      parse_statement,
      Keyword.for("body"),
    ]),
  ])[invoke](tokens);
...
let parse_else_if_branch = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("else_if")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("else"), Keyword.for("if")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
    UntilEither[Meta.create]([
      Set[Meta.create]([Keyword.for("else"), Keyword.for("end")]),
      parse_statement,
...
let parse_if_branch = ParseMap[Meta.from_entries]([
...
let parse_if = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("if")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("if")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
    UntilEither[Meta.create]([
      Set[Meta.create]([Keyword.for("else"), Keyword.for("end")]),
      parse_statement,
    ...
    Chomp[Meta.create]([Keyword.for("end")]),
  ])[invoke](tokens);
};
let parse_let = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("let")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("let")]),
  Then[Meta.create]([parse_assign_expr, Keyword.for("assign_expr")]),
  Chomp[Meta.create]([Keyword.for("eq")]),
...
let parse_if_let = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("if_let")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("if"), Keyword.for("let")]),
    Then[Meta.create]([parse_assign_expr, Keyword.for("assign_expr")]),
    Chomp[Meta.create]([Keyword.for("eq")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
    UntilEither[Meta.create]([
...
let parse_protocol_methods = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("protocol_method")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("open_b")]),
  Until[Meta.create]([Keyword.for("close_b"), parse_id, Keyword.for("names")]),
  Chomp[Meta.create]([Keyword.for("close_b")]),
]);
let parse_protocol = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("protocol_def")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("protocol")]),
  One[Meta.create]([Keyword.for("id"), Keyword.for("name")]),
  Optional[Meta.create]([
    Keyword.for("open_b"),
...
let parse_return = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("return")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("return")]),
  Optional[Meta.create]([
    dot(SINGLE_EXPR_PARSE_MAP, keys)[invoke](),
    parse_expr,
    Keyword.for("expr"),
...
let parse_await_modifier = Parser[Meta.create]([
  Init[Meta.create]([true]),
  Chomp[Meta.create]([Keyword.for("await")]),
]);
let parse_for_loop = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("for_loop")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("for")]),
    Optional[Meta.create]([
      Keyword.for("await"),
    ...
    Then[Meta.create]([parse_assign_expr, Keyword.for("assign_expr")]),
    Chomp[Meta.create]([Keyword.for("of")]),
    Then[Meta.create]([parse_expr, Keyword.for("iterable_expr")]),
    block[invoke](Keyword.for("body")),
  ])[invoke](tokens);
};
let parse_loop = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("loop")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("loop")]),
    block[invoke](Keyword.for("body")),
  ])[invoke](tokens);
};
let parse_while_loop = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("while_loop")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("while")]),
    Then[Meta.create]([parse_expr, Keyword.for("test_expr")]),
    block[invoke](Keyword.for("body")),
  ])[invoke](tokens);
};
let parse_while_let_loop = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("while_let_loop")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("while"), Keyword.for("let")]),
    Then[Meta.create]([parse_assign_expr, Keyword.for("assign_expr")]),
    Chomp[Meta.create]([Keyword.for("eq")]),
    Then[Meta.create]([parse_expr, Keyword.for("test_expr")]),
    block[invoke](Keyword.for("body")),
...
let parse_continue = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("continue")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("continue")]),
  ])[invoke](tokens);
};
let parse_break = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("break")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("break")]),
  ])[invoke](tokens);
};
let parse_catch = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("catch")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("catch")]),
    One[Meta.create]([Keyword.for("id"), Keyword.for("name")]),
    block[invoke](Keyword.for("body")),
  ])[invoke](tokens);
};
let parse_finally = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("finally")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("finally")]),
    block[invoke](Keyword.for("body")),
  ])[invoke](tokens);
};
let parse_try = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("try")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("try")]),
    block[invoke](Keyword.for("body")),
    Optional[Meta.create]([
      Keyword.for("catch"),
      parse_catch,
...
let parse_import = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("import")],
      ]),
    ]),
...
let parse_export = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("export")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("export")]),
    Then[Meta.create]([parse_statement, Keyword.for("statement")]),
  ])[invoke](tokens);
};
let parse_export_default = function (tokens) {
  ...
  return Parser[Meta.create]([
    Init[Meta.create]([
      ObjectLiteral[Meta.from_entries]([
        [Keyword.for("type"), Keyword.for("export_default")],
      ]),
    ]),
    Chomp[Meta.create]([Keyword.for("export"), Keyword.for("default")]),
    Then[Meta.create]([parse_expr, Keyword.for("expr")]),
  ])[invoke](tokens);
};
let parse_direct_import = Parser[Meta.create]([
  Init[Meta.create]([
    ObjectLiteral[Meta.from_entries]([
      [Keyword.for("type"), Keyword.for("direct_import")],
    ]),
  ]),
  Chomp[Meta.create]([Keyword.for("import")]),
...
let resolve_name = function (name) {
  ...
  if (name[Meta.as_bool]()) {
    ...
    return dot(
      dot(
        dot(
          dot(name, Keyword.for("replaceAll"))[invoke]("?", "__q"),
          Keyword.for("replaceAll")
        )[invoke]("!", "__b"),
        Keyword.for("replaceAll")
      )[invoke](">", "_lt_"),
      Keyword.for("replaceAll")
...
let eval_if_branch = function (branch) {
  ...
  if (dot(branch, nil__q)[invoke]()[Meta.as_bool]()) {
    ...
    dot(branch, Keyword.for("type"))[Meta["=="]](Keyword.for("else"))
  ) {
    let __coil_temp;
    return str[invoke](
      " else {\n",
      eval_ast[invoke](
        ((__coil_temp = { left: dot(branch, Keyword.for("body")) }),
        __coil_temp.left[Meta.as_bool]() ? __coil_temp.left : [])
      ),
      "\n}"
    );
  } else if (
    dot(branch, Keyword.for("type"))[Meta["=="]](Keyword.for("else_if"))
  ) {
    let __coil_temp;
    return str[invoke](
      " else if (",
      eval_expr[invoke](dot(branch, at)[invoke](Keyword.for("expr"))),
      ") {\n",
      eval_ast[invoke](
        ((__coil_temp = { left: dot(branch, at)[invoke](Keyword.for("pass")) }),
        __coil_temp.left[Meta.as_bool]() ? __coil_temp.left : [])
      ),
      "\n}",
...
let eval_fn_call = function ({ lhs: lhs, args: args }) {
  ...
  return str[invoke](
    ...
    "[invoke](",
    dot(dot(args, map)[invoke](eval_expr), join)[invoke](", "),
    ")"
  );
};
...
let eval_array_deconstruction_names = function ({ entries: entries }) {
  ...
  return str[invoke](
    "[",
    dot(dot(entries, map)[invoke](eval_array_deconstruction_entry), join)[
      invoke
    ](", "),
    "]"
  );
...
let eval_obj_entry_rename = function ({
  old_name: old_name,
  new_name: new_name,
}) {
...
let eval_object_deconstruction_names = function ({ entries: entries }) {
  ...
  return str[invoke](
    "{",
    dot(dot(entries, map)[invoke](eval_obj_deconstruction_entry), join)[invoke](
      ", "
    ),
    "}"
  );
...
let eval_while_let_loop = function ({
  test_expr: test_expr,
  ...
  return str[invoke](
    ...
    "while (__coil_while_let_temp[Meta.as_bool]()) {\n",
    "let ",
    eval_assign_expr[invoke](assign_expr),
...
let eval_array = function ({ elements: elements }) {
  ...
  return str[invoke](
    "[",
    dot(dot(elements, map)[invoke](eval_expr), join)[invoke](", "),
    "]"
  );
};
let eval_this_assignments = function (args) {
  ...
  return dot(
    dot(
      ...
      str[invoke]("this['", name, "'] = ", resolve_name[invoke](name), ";\n")
    ),
    into
  )[invoke]("");
};
    ...
    [invoke](
      Map[Meta.from_entries]([
        [
          ...
          ({ lhs: lhs, rhs: rhs }) =>
            str[invoke](
              eval_name_expr[invoke](lhs),
              "[",
              eval_name_expr[invoke](rhs),
              "]"
            ),
        ],
        [
          Keyword.for("keyword_lookup"),
          ({ lhs: lhs, property: property }) =>
...
let arg_names = function (node) {
  ...
  return dot(dot(node, at)[invoke](Keyword.for("type")), pipe)
    [invoke](
      Map[Meta.from_entries]([
        [Keyword.for("array_deconstruction"), entries_arg_names],
        [Keyword.for("id_assign"), ({ name: name }) => [name]],
        [Keyword.for("object_deconstruction"), entries_arg_names],
        [Keyword.for("obj_reg_entry"), ({ name: name }) => [name]],
        [
          Keyword.for("obj_entry_rename"),
          ({ new_name: new_name }) => [new_name],
        ],
        [Keyword.for("spread_assign"), ({ name: name }) => [name]],
        [
          Keyword.for("obj_str_rename_entry"),
          ({ new_name: new_name }) => [new_name],
        ],
        [Keyword.for("this_assign"), ({ name: name }) => [name]],
        [Keyword.for("this_spread_assign"), ({ name: name }) => [name]],
      ])
    )
    [invoke](node);
};
...
let eval_fn = function ({
  ...
  return str[invoke](
    ((__coil_temp = {
      left:
        ((__coil_temp = {
          left: dot(name_expr, "type")[Meta["=="]](Keyword.for("id_lookup")),
        }),
        __coil_temp.left[Meta.as_bool]() === false
          ? __coil_temp.left
          : ((__coil_temp.right = "let "),
            __coil_temp.right[Meta.as_bool]() === true)
          ? __coil_temp.right
          : __coil_temp.left),
    }),
    __coil_temp.left[Meta.as_bool]() ? __coil_temp.left : ""),
    eval_name_expr[invoke](name_expr),
    " = ",
    ((__coil_temp = { left: is_async__q }),
    __coil_temp.left[Meta.as_bool]() === false
      ? __coil_temp.left
      : ((__coil_temp.right = "async "),
        __coil_temp.right[Meta.as_bool]() === true)
      ? __coil_temp.right
      : __coil_temp.left),
    "function ",
    ((__coil_temp = { left: generator__q }),
    __coil_temp.left[Meta.as_bool]() === false
      ? __coil_temp.left
      : ((__coil_temp.right = "*"), __coil_temp.right[Meta.as_bool]() === true)
      ? __coil_temp.right
      : __coil_temp.left),
    "(",
...
let eval_meta_from_entries = function ({ lhs: lhs, entries: entries }) {
  ...
  return str[invoke](
    eval_expr[invoke](lhs),
    "[Meta.from_entries]([",
    dot(dot(entries, map)[invoke](eval_record_entry), join)[invoke](", "),
    "])"
  );
};
let eval_meta_create = function ({ lhs: lhs, entries: entries }) {
  ...
  return str[invoke](
    eval_expr[invoke](lhs),
    "[Meta.create]([",
    dot(dot(entries, map)[invoke](eval_expr), join)[invoke](", "),
    "])"
  );
};
...
let eval_regular_record_entry = function ({
  key_expr: key_expr,
  ...
  return str[invoke](
    "[",
    eval_expr[invoke](key_expr),
    ", ",
    eval_expr[invoke](value_expr),
    "]"
  );
};
let eval_keyword_record_entry = function ({ name: name, expr: expr }) {
  ...
  return str[invoke](
    "[",
    eval_keyword[invoke](
      ObjectLiteral[Meta.from_entries]([[Keyword.for("value"), name]])
    ),
    ", ",
    eval_expr[invoke](expr),
    "]"
...
let eval_and = function ({ lhs: lhs, rhs: rhs }) {
  ...
  return str[invoke](
    ...
    eval_expr[invoke](lhs),
    "}",
    ", __coil_temp.left[Meta.as_bool]() === false ? __coil_temp.left : (__coil_temp.right = ",
    eval_expr[invoke](rhs),
    ", __coil_temp.right[Meta.as_bool]() === true) ? __coil_temp.right : __coil_temp.left)"
  );
};
...
let eval_protocol = function ({ name: name, methods: methods }) {
  ...
  if (methods[Meta.as_bool]()) {
    ...
    return str[invoke](
      ...
      " = Object.freeze({",
      dot(
        dot(dot(methods, names), map)[invoke]((method) =>
          str[invoke](
            '"',
            dot(method, "name"),
            '": Symbol("',
...
let eval_for_loop = function ({
  ...
  return str[invoke](
    "for ",
    ((__coil_temp = { left: is_await__q }),
    __coil_temp.left[Meta.as_bool]() === false
      ? __coil_temp.left
      : ((__coil_temp.right = "await "),
        __coil_temp.right[Meta.as_bool]() === true)
      ? __coil_temp.right
      : __coil_temp.left),
    " (let ",
    eval_assign_expr[invoke](assign_expr),
    " of ",
    eval_expr[invoke](iterable_expr),
    ") {\n",
    eval_ast[invoke](body),
    "\n",
    "}"
...
let eval_try = function (node) {
  ...
  if (dot(node, has__q)[invoke](Keyword.for("catch"))[Meta.as_bool]()) {
    let __coil_temp;
    let { name: name, body: body } = dot(node, at)[invoke](
      Keyword.for("catch")
    );
    catch_js = str[invoke](
      " catch (",
...
let get_deconstructed_obj_entry_name = function (node) {
  ...
  return dot(
    dot(
      ...
      at
    )[invoke](dot(node, at)[invoke](Keyword.for("type"))),
    pipe
  )[invoke](node);
};
let get_deconstructed_array_entry_name = function (node) {
  ...
  return dot(
    dot(
      Map[Meta.from_entries]([[Keyword.for("id_assign"), Keyword.for("name")]]),
      at
    )[invoke](dot(node, at)[invoke](Keyword.for("type"))),
    pipe
  )[invoke](node);
    ...
    [invoke](
      ...
      Map[Meta.from_entries]([
        [
          ...
          ({ name: name }) => resolve_name[invoke](name),
        ],
        [
          Keyword.for("obj_entry_rename"),
          ({ old_name: old_name, new_name: new_name }) =>
            str[invoke](
              resolve_name[invoke](old_name),
              " as ",
              resolve_name[invoke](new_name)
            ),
        ],
      ])
    )
...
let eval_import_deconstruction_expr = function ({ entries: entries }) {
  ...
  return str[invoke](
    "{",
    dot(dot(entries, map)[invoke](eval_import_deconstruction_entry), join)[
      invoke
    ](", "),
    "}"
  );
...
let eval_import_assign_exprs = function (node) {
  ...
  return dot(node, pipe)
    [invoke](
      ...
      Map[Meta.from_entries]([
        [Keyword.for("id_assign"), eval_id_assign_name],
        [Keyword.for("object_deconstruction"), eval_import_deconstruction_expr],
